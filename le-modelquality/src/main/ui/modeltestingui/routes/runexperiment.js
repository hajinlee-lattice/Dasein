...
hdfs.writeFile(hdfsPipelineTarFile, req.files["pipelineTARGZ"].data, function (err, success) {
  ...
  // Send post request!
  var url = "https://admin-qa.lattice.local:8080/modelquality/runmodel/?tenant=ModelQualityExperiments.ModelQualityExperiments.Production&username=ga_dev@lattice-engines.com&password=WorkflowAp1&apiHostPort=https://bodcdevtca18.lattice.local:8081"

...
public class ConfigurationCacheControllerUnitTestNG {
    ...
    public void testPodCreateDeleteDocument() throws Exception {
        ...
        ConfigurationCacheController<PodScope> controller = new ConfigurationCacheController<PodScope>(scope);
    ...
    public void testContractCreateDeleteDocument() throws Exception {
        ...
        Path path = new Path("/foo");
        ConfigurationCacheController<ContractScope> controller = new ConfigurationCacheController<ContractScope>(scope);
        controller.create(path, new Document("foo"));
        Assert.assertTrue(controller.exists(path));
        Assert.assertTrue(CamilleEnvironment.getCamille().exists(
    ...
    public void testTenantCreateDeleteDocument() throws Exception {
        ...
        Path path = new Path("/foo");
        ConfigurationCacheController<TenantScope> controller = new ConfigurationCacheController<TenantScope>(scope);
        controller.create(path, new Document("foo"));
        Assert.assertTrue(controller.exists(path));
        Assert.assertTrue(CamilleEnvironment.getCamille().exists(
    ...
    public void testSpaceCreateDeleteDocument() throws Exception {
        ...
        Path path = new Path("/foo");
        ConfigurationCacheController<CustomerSpaceScope> controller = new ConfigurationCacheController<CustomerSpaceScope>(
                scope);
        controller.create(path, new Document("foo"));
        Assert.assertTrue(controller.exists(path));
        Assert.assertTrue(CamilleEnvironment.getCamille().exists(

...
public final class PathBuilder {
    ...
    public static Path buildTenantPath(String podID, String contractID, String tenantID) {
        return new Path(DirectoryConstants.PODS, podID, DirectoryConstants.CONTRACTS, contractID,
                DirectoryConstants.TENANTS, tenantID);
    ...
    public static Path buildTenantServicePath(String podID, String contractID, String tenantID, String spaceID,
            String serviceName) {
        return new Path(DirectoryConstants.PODS, podID, DirectoryConstants.CONTRACTS, contractID,
                DirectoryConstants.TENANTS, tenantID, DirectoryConstants.SPACES, spaceID, DirectoryConstants.SERVICES,
                serviceName);
    }
}

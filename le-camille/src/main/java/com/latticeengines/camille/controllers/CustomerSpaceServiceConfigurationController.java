...
public class CustomerSpaceServiceConfigurationController extends ConfigurationController {
    private CustomerSpaceServiceScope scope;
    
    public CustomerSpaceServiceConfigurationController(CustomerSpaceServiceScope scope) {
        this.scope = scope;
    }

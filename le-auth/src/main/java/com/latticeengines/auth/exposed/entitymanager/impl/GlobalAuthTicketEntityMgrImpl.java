...
public class GlobalAuthTicketEntityMgrImpl extends BaseEntityMgrImpl<GlobalAuthTicket>
    ...
    public List<GlobalAuthTicket> findTicketsByUserIdAndExternalIssuer(Long userId, String issuer) {
        return gaTicketDao.findTicketsByUserIdAndExternalIssuer(userId, issuer);
    }
    ...
    public List<GlobalAuthTicket> findByUserAndTenantIdAndNotInTicketAndLastAccessDate(Long tenantId, Long userId, String ticket) {
        return gaTicketDao.findByUserAndTenantIdAndNotInTicketAndLastAccessDate(tenantId, userId, ticket);
    }

...
public class ScoringJobUtilTestNG extends ScoringFunctionalTestNGBase {
    ...
    public void findModelUrlsToLocalize() throws Exception {
        ...
        List<String> modelUrls = ScoringJobUtil.findModelUrlsToLocalize(yarnConfiguration, tenant,
                modelGuidsFromTable, modelFilePaths);
    ...
    public void testGenerateDataTypeSchema() throws JsonParseException, JsonMappingException, IOException, Exception {
        ...
        ScoringJobUtil.generateDataTypeSchema(schema, dir + "/datatype.json", yarnConfiguration);
        @SuppressWarnings("deprecation")
        Map<String, String> map = new ObjectMapper().readValue(
                HdfsUtils.getHdfsFileContents(yarnConfiguration, dir + "/datatype.json"),

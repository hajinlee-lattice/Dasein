package com.latticeengines.propdata.service.impl;
...
public class PropDataServicemplTestNG extends AbstractTestNGSpringContextTests {
    ...
    public void createDomainIndex() {
        ...
        indexTable(domainIndexTable, "HGData_Source", "Url", "uuid", "domain_name", limit);
        indexTable(domainIndexTable, "BuiltWithDomain", "Domain", "uuid", "domain_name", limit);
        indexTable(domainIndexTable, "Experian_Source", "URL", "uuid", "domain_name", limit);
    }

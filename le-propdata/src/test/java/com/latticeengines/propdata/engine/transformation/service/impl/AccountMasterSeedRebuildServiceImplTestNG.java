        ...
        while (records.hasNext()) {
            ...
            Assert.assertTrue(
                       (latticeId == 1 && primaryDuns.equals("DnB_04_PRIMARY_DUNS")
                            ...
                            && naicsCode.equals("DnB_04_NAICS_CODE") && revenueRange.equals("DnB_04_REVENUE_RANGE")
                            && street.equals("DnB_04_ADDR") && country.equals("DnB_04_COUNTRY") && domain.equals("null")
                            && isPrimaryDomain.equals("N"))
                    || (latticeId == 2 && primaryDuns.equals("DnB_01_PRIMARY_DUNS")
                            && leCountry.equals("DnB_01_LE_COUNTRY") && companyPhone.equals("DnB_01_COMPANY_PHONE")
                            ...
                            && naicsCode.equals("DnB_01_NAICS_CODE") && revenueRange.equals("DnB_01_REVENUE_RANGE")
                            && street.equals("DnB_01_ADDR") && country.equals("DnB_01_COUNTRY") && domain.equals("e.com")
                            && isPrimaryDomain.equals("N"))
                    || (latticeId == 3 && primaryDuns.equals("DnB_01_PRIMARY_DUNS")
                            ...
                            && name.equals("DnB_01_NAME") && duns.equals("01") && state.equals("DnB_01_STATE")
                            && naicsCode.equals("DnB_01_NAICS_CODE") && revenueRange.equals("DnB_01_REVENUE_RANGE")
                            && street.equals("DnB_01_ADDR") && country.equals("DnB_01_COUNTRY") && domain.equals("b.com")
                            && isPrimaryDomain.equals("N"))
                    || (latticeId == 4 && primaryDuns.equals("DnB_03_PRIMARY_DUNS")
                            && leCountry.equals("DnB_03_LE_COUNTRY") && companyPhone.equals("DnB_03_COMPANY_PHONE")
                            ...
                            && naicsCode.equals("DnB_03_NAICS_CODE") && revenueRange.equals("DnB_03_REVENUE_RANGE")
                            && street.equals("DnB_03_ADDR") && country.equals("DnB_03_COUNTRY") && domain.equals("a.com")
                    ...
                    || (latticeId == 5 && primaryDuns.equals("DnB_01_PRIMARY_DUNS")
                            ...
                            && name.equals("DnB_01_NAME") && duns.equals("01") && state.equals("DnB_01_STATE")
                            && naicsCode.equals("DnB_01_NAICS_CODE") && revenueRange.equals("DnB_01_REVENUE_RANGE")
                            && street.equals("DnB_01_ADDR") && country.equals("DnB_01_COUNTRY") && domain.equals("c.com")
                            && isPrimaryDomain.equals("Y"))
                    || (latticeId == 6 && primaryDuns.equals("DnB_01_PRIMARY_DUNS")
                            ...
                            && name.equals("DnB_01_NAME") && duns.equals("01") && state.equals("DnB_01_STATE")
                            && naicsCode.equals("DnB_01_NAICS_CODE") && revenueRange.equals("DnB_01_REVENUE_RANGE")
                            && street.equals("DnB_01_ADDR") && country.equals("DnB_01_COUNTRY") && domain.equals("a.com")
                            && isPrimaryDomain.equals("N"))
                    || (latticeId == 7 && primaryDuns.equals("null")
                            && leCountry.equals("null") && companyPhone.equals("null")
                            && employeeRange.equals("null")
                            && companyDescription.equals("null")
                            && zipcode.equals("null") && numberOfLocations == 1
                            && sicCode.equals("null") && isPrimaryLocation.equals("Y")
                            && city.equals("LE_NULL_CITY_2") && industry.equals("null")
                            && name.equals("LE_NULL_NAME_2") && duns.equals("null") && state.equals("LE_NULL_STATE_2")
                            && naicsCode.equals("null") && revenueRange.equals("null")
                            && street.equals("null") && country.equals("LE_NULL_COUNTRY_2") && domain.equals("d.com")
                            && isPrimaryDomain.equals("Y"))
                    || (latticeId == 8 && primaryDuns.equals("DnB_02_PRIMARY_DUNS")
                            ...
                            && street.equals("DnB_02_ADDR") && country.equals("DnB_02_COUNTRY") && domain.equals("a.com")
                            && isPrimaryDomain.equals("Y")));
            rowNum = rowNum + 1;
        }

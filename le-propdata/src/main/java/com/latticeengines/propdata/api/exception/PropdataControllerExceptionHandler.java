package com.latticeengines.propdata.api.exception;
...
public class PropdataControllerExceptionHandler extends SecurityControllerExceptionHandler {
    private static final Log log = LogFactory.getLog(PropdataControllerExceptionHandler.class);

    @Autowired
    private AlertService alertService;

    public PropdataControllerExceptionHandler() {
    }
    ...
    public ModelAndView handleException(LedpException e) {
        ...
        return new ModelAndView(jsonView, ImmutableMap.of("errorCode", e.getCode().name(), //
                "errorMsg", e.getMessage(), "stackTrace", ExceptionUtils.getFullStackTrace(ExceptionUtils.getCause(e))));
    }
    ...
    public ModelAndView handleException(Exception e) {
        ...
        return new ModelAndView(jsonView, ImmutableMap.of("errorCode", LedpCode.LEDP_00002.name(), //
                "errorMsg", stackTrace, "stackTrace", ExceptionUtils.getFullStackTrace(ExceptionUtils.getCause(e))));
    }
}

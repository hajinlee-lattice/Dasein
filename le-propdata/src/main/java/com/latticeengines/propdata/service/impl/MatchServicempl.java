...
import com.latticeengines.propdata.service.SourceSpec;
...
public class MatchServicempl implements MatchService {
	...
	@Override
	public Map<String, Map<String, Object>> match(String domain,
			List<String> sources) {
	...
	public void createDomainIndex(String sourceName) {
		...
		indexTable(domainIndexTable, sourceName, sourceDomainColumn,
				sourceKeyColumn, indexKeyColumn, limit);
	}

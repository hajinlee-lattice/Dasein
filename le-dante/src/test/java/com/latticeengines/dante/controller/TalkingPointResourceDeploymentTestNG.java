...
public class TalkingPointResourceDeploymentTestNG extends AbstractTestNGSpringContextTests {
    ...
    public void testCreateFromService() {
        ...
        dtp = objMapper.convertValue(talkingPointProxy.findByExternalID(externalID).getResult(),
        ...
        dtps = objMapper.convertValue(talkingPointProxy.findAllByPlayID("testDPlayExtID").getResult(),
    ...
    public void testDanteOauth() {
        ...
        ResponseDocument<DantePreviewResources> response = talkingPointProxy.getPreviewResources(testTenantName);

...
public class SkaldDestination implements RecordDestination
{
    ...
    { 
        ...
        {
        	log.error(combinationKeyField + " field was not present in the request for customer : " + customerSpace.toString());
    ...
    @Autowired
    private MarketoAdapaterProperties properties;
    private String combinationKeyField = "LatticeCombination";

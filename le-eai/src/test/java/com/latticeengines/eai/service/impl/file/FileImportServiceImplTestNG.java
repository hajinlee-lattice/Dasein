...
public class FileImportServiceImplTestNG extends EaiFunctionalTestNGBase {
    ...
    public void importMetadataAndDataAndWriteToHdfs(Map<String, String> properties) throws Exception {
        ...
        assertEquals(counters.getCounter(com.latticeengines.domain.exposed.mapreduce.counters.RecordImportCounter.IMPORTED_RECORDS).getValue(), 8);
        assertEquals(counters.getCounter(RecordImportCounter.IGNORED_RECORDS).getValue(), 11);

...
JAVA_OPTIONS=(-XX:MaxPermSize=2048m -Dcom.latticeengines.registerBootstrappers=true -Djetty.class.path=$JAVA_HOME/lib/tools.jar -DADMIN_PROPDIR=/etc/ledp -DSECURITY_PROPDIR=/etc/ledp -Djavax.net.ssl.trustStore=/etc/ledp/laca-ldap.dev.lattice.local.jks)

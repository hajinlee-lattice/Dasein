...
export default class OverviewComponent extends Component {
    ...
    launchHistoryLink(play) {
        if(play.launchHistory.mostRecentLaunch && ['Launching','Launched','Failed'].indexOf(play.launchHistory.mostRecentLaunch.launchState) !== -1 || play.launchHistory.lastCompletedLaunch.launchState) {
            return(
                <a href="javascript:void(0);" onClick={() => {

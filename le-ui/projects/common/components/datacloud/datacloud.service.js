...
.service('DataCloudStore', function($q, DataCloudService){
    ...
    this.getDataCollectionCube = function() {
        if (this.cube) {
            return this.cube;
        }

        var deferred = $q.defer();
        DataCloudService.getDataCollectionCube().then(function(response){
            deferred.resolve(response);
        });
...
.service('MyDataStore', function($q, MyDataService){
    var MyDataStore = this;
    ...
    this.getPremiumSelectMaximum = function(){
        ...
        if (this.premiumSelectMaximum) {
            ...
            MyDataService.getPremiumSelectMaximum().then(function(response){
                MyDataStore.setPremiumSelectMaximum(response);
                deferred.resolve(response);
            });
        }
        return deferred.promise;
    ...
    this.getCategories = function(){
        ...
        if (this.categories) {
            ...
            MyDataService.getCategories().then(function(response){
                MyDataStore.setCategories(response);
                deferred.resolve(response);
            });
        }
        return deferred.promise;
    ...
    this.getSubcategories = function(category){
        ...
        if (this.subcategories[category]) {
            ...
            MyDataService.getSubcategories(category).then(function(response){
                MyDataStore.setSubcategories(category, response);
                deferred.resolve(response);
            });
        }
        return deferred.promise;
    ...
    this.getEnrichments = function(opts){
        ...
        if (this.enrichments) {
            ...
            MyDataService.getEnrichments(opts).then(function(response){
            //MyDataStore.setEnrichments(response);
                deferred.resolve(response);
            });
        }
        return deferred.promise;
    ...
    this.getCount = function(){
        ...
        if (this.count) {
            ...
            MyDataService.getCount().then(function(response){
                deferred.resolve(response);
            });
        }
        return deferred.promise;
    ...
    this.getSelectedCount = function(){
        ...
        if (this.selectedCount) {
            ...
            MyDataService.getSelectedCount().then(function(response){
                deferred.resolve(response);
            });
        }
        return deferred.promise;
    ...
    this.getTopAttributes = function(opts) {
        ...
        if (this.topAttributes) {
            ...
            MyDataService.getTopAttributes(opts).then(function(response) {
                for(var i in response.data.SubCategories) {
                    var items = response.data.SubCategories[i];
                    for(var j in items) {
                        var item = items[j],
                ...
                MyDataStore.setTopAttributes(response, opts.category);
                deferred.resolve(response);
            });
        }
        return deferred.promise;
    ...
    this.getAllTopAttributes = function(opts) {
        ...
        if (this.topAttributes) {
            ...
            MyDataService.getAllTopAttributes(opts).then(function(response) {
                vm.topAttributes = response.data; // ben
                deferred.resolve(vm.topAttributes);
            });
        }
    ...
    this.getCube = function() {
        ...
        var deferred = $q.defer();
        MyDataService.getCube().then(function(response){
            deferred.resolve(response);
        });

        MyDataStore.setCube(deferred.promise);
        return deferred.promise;
    }
    ...
    this.getDataCollectionCube = function() {
        ...
        var deferred = $q.defer();
        MyDataService.getDataCollectionCube().then(function(response){
            deferred.resolve(response);
        });
...
.service('MyDataService', function($q, $http, $state) {
    this.host = '/pls'; //default
    ...
    this.getPremiumSelectMaximum = function(){
        ...
        $http({
            ...
            //ENVs: Default, QA, Production
            //url: '/Pods/<ENV>/Default/PLS/EnrichAttributeMaxNumber'
            url: this.host + '/datacollection/premiumattributeslimitation'
        }).then(function(response){
            deferred.resolve(response);
        });
        return deferred.promise;
    ...
    this.getCount = function(){
        ...
        $http({
            method: 'get',
            url: this.host + '/datacollection/attributes/count'
        }).then(function(response){
            deferred.resolve(response);
        });
        return deferred.promise;
    ...
    this.getSelectedCount = function(){
        ...
        $http({
            method: 'get',
            url: this.host + '/datacollection/statistics/selectedattributes/count'
        }).then(function(response){
            deferred.resolve(response);
        });
        return deferred.promise;
    ...
    this.getCategories = function(){
        ...
        $http({
            method: 'get',
            url: this.host + '/datacollection/statistics/categories'
        }).then(function(response){
            deferred.resolve(response);
        });
        return deferred.promise;
    ...
    this.getSubcategories = function(category){
        ...
        $http({
            method: 'get',
            url: this.host + '/datacollection/statistics/subcategories',
            params: {
                category: category
            }
        }).then(function(response){
    ...
    this.getEnrichments = function(opts){
        ...
        $http({
            method: 'get',
            url: this.host + '/datacollection/attributes',
            params: {
                offset: offset,
                max: max,
                onlySelectedAttributes: onlySelectedAttributes
    ...
    this.getTopAttributes = function(opts) {
        ...
        $http({
            method: 'get',
            url: this.host + '/datacollection/statistics/topn',
            params: {
                category: opts.category,
                limit: opts.limit,
                loadEnrichmentMetadata: opts.loadEnrichmentMetadata
    ...
    this.getAllTopAttributes = function(opts) {
        ...
        $http({
            method: 'get',
            url: this.host + '/datacollection/statistics/topn/all',
            params: {
                max: 9999,
                loadEnrichmentMetadata: opts.loadEnrichmentMetadata
            }
    ...
    this.getCube = function(opts){
        ...
        $http({
            method: 'get',
            url: this.host + '/datacollection/statistics/cube',
            params: {
                q: query
            }
        }).then(function(response){

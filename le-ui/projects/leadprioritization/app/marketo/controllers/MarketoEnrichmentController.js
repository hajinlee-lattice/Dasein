...
.controller('MarketoEnrichmentController', function($scope, $timeout, $state, $stateParams, BrowserStorageUtility, EnrichmentData, MarketoCredentialsData){
    var vm = this;
    ...
    var marketoData = [];
    console.log(MarketoCredentialsData);

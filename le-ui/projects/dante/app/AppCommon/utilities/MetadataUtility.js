...
.service('MetadataUtility', function (SortUtility) {
    ...
    // gets all Properties with key and value
    this.GetNotionPropertiesOfKeyValue = function (key, value, notionMetadata) {
        if (notionMetadata == null || notionMetadata.Properties == null ||
            key == null || key === "") {
            return null;
        }

        return notionMetadata.Properties.filter(function (property) {

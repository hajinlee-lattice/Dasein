...
.service('DateTimeFormatUtility', function () {
    ...
    */
    ...
    this.Today = function (includeTime) {
        includeTime = includeTime != null && typeof includeTime === "boolean" ? includeTime : false;
        
        var today = new Date();
        var toReturn = (today.getMonth() + 1) + "/" + today.getDate() + "/" + today.getFullYear();
        if (includeTime) {
            ...
            toReturn += " " + hours + ":" + today.getMinutes() + " " + amPm;
        }
        
        return toReturn;
    };
    
    this.TodayUTC = function (includeTime) {
        includeTime = includeTime != null && typeof includeTime === "boolean" ? includeTime : false;
        
        var today = new Date();
        var toReturn = (today.getUTCMonth() + 1) + "/" + today.getUTCDate() + "/" + today.getUTCFullYear();
        if (includeTime) {
            ...
            toReturn += " " + hours + ":" + today.getUTCMinutes() + " " + amPm;
        }

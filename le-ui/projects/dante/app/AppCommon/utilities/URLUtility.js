...
.service('URLUtility', function () {
    ...
    */
    ...
    this.CrmRecommendation = function () {
        return this.GetQueryStringValue("Recommendation");
    };
    ...
    this.CrmOpportunity = function () {
        return this.GetQueryStringValue("Opportunity");
    };

    this.HasSalesprism = function () {
        return this.GetQueryStringValue("HasSalesprism");
    };

    this.CrmPurchaseHistoryAccount = function () {
        return this.GetQueryStringValue("PurchaseHistoryAccount");
    };

    this.LpiPreview = function() {
        return this.GetQueryStringValue("LpiPreview");
    };

    this.CustomSettings = function () {
        return this.GetQueryStringValue("CustomSettings");
    };

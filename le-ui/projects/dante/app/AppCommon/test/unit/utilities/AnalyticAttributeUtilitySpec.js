...
describe('AnalyticAttributeUtility Tests', function () {
    ...
    describe('FindAttributeBucket given model summary buckets with 1.0/0.0 and predictor buckets with Yes/No', function () {
        var toReturn;
        
        var yesBucket = {
            AttributeName: "Attr5",
            ColumnName: "Attr5Name2",
            AttributeValue: "Yes"
        };
        
        var expectedModelSummaryYesBucket = {
            ColumnName: "Attr5Name2",
            Values: [
                "1.0"
            ],
        ...
        var noBucket = {
            AttributeName: "Attr5",
            ColumnName: "Attr5Name1",
            AttributeValue: "No"
        };
        
        var expectedModelSummaryNoBucket = {
            ColumnName: "Attr5Name1",
            Values: [
                "0.0"
            ],
        ...
        it('should return a bucket that says Yes for model summary bucket that has 1.0', function () {
            toReturn = analyticAttributeUtility.FindAttributeBucket(sampleModelSummary, yesBucket);
            expect(toReturn).toEqual(expectedModelSummaryYesBucket);
        });
        
        it('should return a bucket that says No for model summary bucket that has 0.0', function () {
            toReturn = analyticAttributeUtility.FindAttributeBucket(sampleModelSummary, noBucket);
            expect(toReturn).toEqual(expectedModelSummaryNoBucket);
        });
    });
    ...
    describe('IsAllowedForInsights tests', function () {
        ...
        it('should return false if ApprovedUsage is null', function () {
        ...
        it('should return false if ApprovedUsage is an empty array', function () {
        ...
        var sampleMetadata5 = {
            ...
            DisplayName: "One",
            DataType: "Number",
            ApprovedUsage: ["IndividualDisplay"]
        };
        it('should return true if ApprovedUsage contains IndividualDisplay as a value', function () {
            toReturn = analyticAttributeUtility.IsAllowedForInsights(sampleMetadata5);
            expect(toReturn).toBe(true);
        });
    });

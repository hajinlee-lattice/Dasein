    ...
    function (DropdownService) {
      return {
        ...
        templateUrl: function (element, attrs) {
          return attrs.dropdownTemplateUrl || 'ngDropdowns/templates/dropdownSelect.html';
        }
      };
    }
  ]);
  ...
  dd.directive('dropdownSelectItem', [
    function () {
      return {
        ...
        templateUrl: function (element, attrs) {
          return attrs.dropdownTemplateUrl || 'ngDropdowns/templates/dropdownSelectItem.html';
        }
      };
    }
  ]);

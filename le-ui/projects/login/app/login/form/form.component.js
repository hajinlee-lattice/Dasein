angular
    ...
    .component("loginForm", {
        ...
        controller: function(
            ...
            vm.$onInit = function() {
                vm.isLoggedInWithTempPassword =
                    vm.logindocument.MustChangePassword;
                vm.isPasswordOlderThanNinetyDays = TimestampIntervalUtility.isTimestampFartherThanNinetyDaysAgo(
                ...
                LoginService.Login(vm.username, vm.password).then(function(
                    ...
                    if (result !== null && result.Success === true) {
                        if (
                            ...
                            vm.params.constructor === Object &&
                            vm.params.type == "jwt"
                        ) {
                            LoginService.PostToJwt(vm.params).then(function(
                                result
                            ) {
            ...
            vm.ssoClick = function() {
                ...
                LoginService.SSOLogin(vm.tenantName, params).then(function(
                    result
                ) {
                    vm.loginInProgress = false;
            ...
            vm.showLoginHeaderMessage = function(message) {
                ...
                if (message.indexOf("Global Auth") > -1) {
                    message = ResourceUtility.getString(
                        "LOGIN_GLOBAL_AUTH_ERROR"
                    );
                }

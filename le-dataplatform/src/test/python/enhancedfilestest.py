...
class EnhancedFilesTest(TrainingTestBase):
    ...
    def check_model_summary(self):
        ...
        self.assertEqual(details["TotalLeads"], 21334)
        self.assertEqual(details["TestingLeads"], 4294)
        self.assertEqual(details["TrainingLeads"], 17040)
        self.assertEqual(details["TotalConversions"], 502)
        self.assertEqual(details["TestingConversions"], 105)
        self.assertEqual(details["TrainingConversions"], 397)

...
class ConversionRateCategoricalColumnTransformTest(TrainingTestBase):
    ...
    def checkConversionRateAssignment(self):
        ...
        columnMapping = conversionRateAssigner.categoricalColumnMapping
        for index, convertedValue in convertedDF[columnsToTransform.keys()].itertuples():
        ...
        for index, convertedValue in testingConvertedDF[columnsToTransform.keys()].itertuples():

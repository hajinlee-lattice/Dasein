...
public class LedpQueueAssignerUnitTestNG {
    ...
    public void beforeClass() throws Exception {
        ...
        // For an easier view, the mocked QueueManager reflects the queue structure captured in yqasMockSchedulerInfo.xml.
    ...
    private FSQueue generateP0Queue(FSQueue p0MRQ) {
        ...
        when(p0_0.getAppSchedulables()).thenReturn(apps);
        ...
        when(p0_1.getAppSchedulables()).thenReturn(apps);
        ...
        when(p0_2.getAppSchedulables()).thenReturn(apps);
        ...
        when(p0_3.getAppSchedulables()).thenReturn(apps);
        ...
        when(p0_4.getAppSchedulables()).thenReturn(apps);
        when(p0_4.getQueueName()).thenReturn("root.Priority0.4");
        p0childQueues.add(p0_4);
        
        when(p0Q.getChildQueues()).thenReturn(p0childQueues);
    ...
    private FSQueue generateP0MapReduceQueue() {
        ...
        when(p0MR_1.getAppSchedulables()).thenReturn(apps);
        ...
        when(p0MR_2.getAppSchedulables()).thenReturn(apps);
        ...
        apps = generateAppSchedCollectionOfSize(30);
        when(p0MR_3.getAppSchedulables()).thenReturn(apps);
        ...
        apps = generateAppSchedCollectionOfSize(30);
        when(p0MR_4.getAppSchedulables()).thenReturn(apps);
    ...
    private FSQueue generateP1Queue() {
        ...
        apps = generateAppSchedCollectionOfSize(10);
        when(p1_0.getAppSchedulables()).thenReturn(apps);
    ...
    private FSQueue generateQueueWithEmptyLeaves() {
        ...
        when(emptyQ.getChildQueues()).thenReturn(emptyChildQueues);

...
public class DBRecordReader<T extends DBWritable> extends RecordReader<LongWritable, T> {
    ...
    public DBRecordReader(DBInputFormat.DBInputSplit split, Class<T> inputClass, Configuration conf, Connection conn,
    ...
    protected String getSelectQuery() {
        ...
        if (dbConf.getInputQuery() == null) {
            ...
            query.append(" AS ").append(tableName); // in hsqldb this is
                                                    // necessary

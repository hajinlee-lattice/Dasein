...
public class DataDrivenImportJob extends ImportJobBase {
    ...
    protected void configureMapper(Job job, String tableName, String tableClassName) throws IOException {
        ...
        if (options.getFileLayout() == SqoopOptions.FileLayout.TextFile) {
            ...
            AvroSchemaGenerator generator = new AvroSchemaGenerator(options, connManager, tableName);
            ...
            LOG.info("Using ledp DataDrivenImportJob");
        ...
        LOG.info("$$$$$$$$$$$$$$$$$$$$$$$$$$$");
        System.out.println("ImportSource is:" + job.getConfiguration().get("importMapperClass"));
    ...
    /**
     * Build the boundary query for the column of the result set created by the
     * given query.
     * 
     * @param col
     *            column name whose boundaries we're interested in.
     * @param query
     *            sub-query used to create the result set.
    ...
    protected void configureInputFormat(Job job, String tableName, String tableClassName, String splitByCol)
        ...
        try {
            ...
            if (null != tableName) {
                ...
                DataDrivenDBInputFormat.setInput(job, DBWritable.class, mgr.escapeTableName(tableName), whereClause,
                ...
                if (options.getBoundaryQuery() != null) {
                    DataDrivenDBInputFormat.setBoundingQuery(job.getConfiguration(), options.getBoundaryQuery());
                }
            } else {
                // Import a free-form query.
                String inputQuery = options.getSqlQuery();
                String sanitizedQuery = inputQuery.replace(DataDrivenDBInputFormat.SUBSTITUTE_TOKEN, " (1 = 1) ");

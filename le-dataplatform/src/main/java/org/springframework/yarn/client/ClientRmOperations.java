...
public interface ClientRmOperations {
     ...
     * get a new {@link org.apache.hadoop.yarn.api.records.ApplicationId} but
     * response also contains information about resource capabilities.
     *
    ...
    /**
     * Submits a new application into resource manager. Returned response is an
     * empty placeholder, thus application submission is considered to be
    ...
    List<ApplicationReport> listApplications(GetApplicationsRequest request);
}

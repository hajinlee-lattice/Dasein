    ...
    def execute(self):
        try:
            ...
            if self.usePeriodID:
                ...
                periodMapping = self.groupedValueIndicies(periodOffset)
            ...
            eventScores = self.replaceNullsWithZero(self.calculateEventScore(event, eventRanking))
            ...
            if mediator.revenueColumn != None:
                ...
                precisionRecallValueMatrix = self.precisionRecallMatrix2(valueRanking, valueSpent)
                precisionRecallEVMatrix = self.precisionRecallMatrix2(expectedValueRanking, valueSpent)

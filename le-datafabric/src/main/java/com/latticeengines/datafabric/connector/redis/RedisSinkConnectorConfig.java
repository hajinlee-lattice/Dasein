...
public class RedisSinkConnectorConfig extends AbstractConfig {
    ...
    private static final String REDIS_SERVERS_DOC = "The desination Redis cluster to sink records";
    ...
    private static final String REDIS_PORT_DOC = "The desination port of Redis cluster";
    ...
    private static final String REDIS_HA_DOC = "Is Ha enabled for redis cluster";
    ...
    private static final String REDIS_MASTER_DOC = "Master node of  redis cluster";
    ...
    private static final String REDIS_REPO_DOC = "The repository inside Redis data store";
    ...
    private static final String REDIS_RECORD_DOC = "The type of records to be sinked";
    ...
    private static final String SHUTDOWN_TIMEOUT_DOC = "Clean shutdown timeout. This makes sure that asynchronous Hive metastore updates are "
    ...
    private static final String SCHEMA_CACHE_SIZE_DOC = "The size of the schema cache used in the Avro converter.";
    ...
    static {
        ...
        config.define(REDIS_SERVERS_CONFIG, Type.STRING, REDIS_SERVERS_DEFAULT, Importance.HIGH, REDIS_SERVERS_DOC,
                REDIS_GROUP, 2, Width.MEDIUM, REDIS_SERVERS_DISPLAY)
                .define(REDIS_PORT_CONFIG, Type.INT, REDIS_PORT_DEFAULT, Importance.HIGH, REDIS_PORT_DOC, REDIS_GROUP,
                        4, Width.SHORT, REDIS_PORT_DISPLAY)
                .define(REDIS_HA_CONFIG, Type.BOOLEAN, REDIS_HA_DEFAULT, Importance.HIGH, REDIS_HA_DOC, REDIS_GROUP, 4,
                        Width.SHORT, REDIS_HA_DISPLAY)
                .define(REDIS_MASTER_CONFIG, Type.STRING, REDIS_MASTER_DEFAULT, Importance.HIGH, REDIS_MASTER_DOC,
                        REDIS_GROUP, 4, Width.SHORT, REDIS_MASTER_DISPLAY)
                .define(REDIS_REPO_CONFIG, Type.STRING, REDIS_REPO_DEFAULT, Importance.HIGH, REDIS_REPO_DOC,
                        REDIS_GROUP, 4, Width.SHORT, REDIS_REPO_DISPLAY)
                .define(REDIS_RECORD_CONFIG, Type.STRING, REDIS_RECORD_DEFAULT, Importance.HIGH, REDIS_RECORD_DOC,
                        REDIS_GROUP, 4, Width.SHORT, REDIS_RECORD_DISPLAY);

        // Define Schema configuration group
        config.define(SCHEMA_CACHE_SIZE_CONFIG, Type.INT, SCHEMA_CACHE_SIZE_DEFAULT, Importance.LOW,
                SCHEMA_CACHE_SIZE_DOC, SCHEMA_GROUP, 2, Width.SHORT, SCHEMA_CACHE_SIZE_DISPLAY);

        // Define Connector configuration group
        config.define(FLUSH_SIZE_CONFIG, Type.INT, Importance.HIGH, FLUSH_SIZE_DOC, CONNECTOR_GROUP, 1, Width.SHORT,
                FLUSH_SIZE_DISPLAY)
                .define(RETRY_BACKOFF_CONFIG, Type.LONG, RETRY_BACKOFF_DEFAULT, Importance.LOW, RETRY_BACKOFF_DOC,
                        CONNECTOR_GROUP, 3, Width.SHORT, RETRY_BACKOFF_DISPLAY)
                .define(SHUTDOWN_TIMEOUT_CONFIG, Type.LONG, SHUTDOWN_TIMEOUT_DEFAULT, Importance.MEDIUM,
                        SHUTDOWN_TIMEOUT_DOC, CONNECTOR_GROUP, 4, Width.SHORT, SHUTDOWN_TIMEOUT_DISPLAY);

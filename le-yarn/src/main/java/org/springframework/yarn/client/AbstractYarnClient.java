...
public abstract class AbstractYarnClient implements YarnClient, InitializingBean {
    ...
    public ApplicationId submitApplication(boolean distribute) {
        ...
        if (resourceLocalizer instanceof SmartResourceLocalizer) {
            ...
            log.warn(
                    "Resource localizer is not instance of SmartResourceLocalizer, thus we're unable to resolve and distrute manually");
        }
    ...
    public void installApplication() {
        if (resourceLocalizer instanceof SmartResourceLocalizer) {
            ...
            log.warn(
                    "Resource localizer is not instance of SmartResourceLocalizer, thus we're unable to ask copy operation");
        }
    }
    ...
    public List<ApplicationReport> listApplications(GetApplicationsRequest request) {
        return clientRmOperations.listApplications(request);
    }
    ...
    /**
     * Sets the {@link ClientRmOperations} implementation for accessing resource
     * manager.
     *
     * @param clientRmOperations
     *            The client to resource manager implementation
     */
     ...
     *
     * @param commands
     *            the commands starting appmaster
     */
    ...
    /**
     * Get the {@link Configuration} of this client. Internally this method is
     * called to get the configuration which allows sub-classes to override and
     ...
     *
     * @param resourceLocalizer
     *            the new resource localizer
     */
     ...
     *            the new application label expression
     */
     ...
     *
     * @param stagingDirPath
     *            the new staging dir path
     */

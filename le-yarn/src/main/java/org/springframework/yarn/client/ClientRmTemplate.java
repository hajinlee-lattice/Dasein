...
/**
 * Template implementation for {@link ClientRmOperations} wrapping communication
 * using {@link ApplicationClientProtocol}. Methods for this template wraps
 * possible exceptions into Spring Dao exception hierarchy.
 *
...
public class ClientRmTemplate extends YarnRpcAccessor<ApplicationClientProtocol> implements ClientRmOperations {
    ...
    @Override
    public List<ApplicationReport> listApplications(final EnumSet<YarnApplicationState> states,

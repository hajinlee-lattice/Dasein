...
public class LedpMetrics implements MetricsSource {
    ...
    @Metric("Container wait time")
    MutableGaugeLong containerWaitTime;
    @Metric("Application wait time")
    MutableGaugeLong applicationWaitTime;
    @Metric("Container elapsed time")
    MutableGaugeLong containerElapsedTime;
    @Metric("Application cleanup time")
    MutableGaugeLong applicationCleanupTime;
    @Metric("Number container preemptions")
    MutableCounterInt numContainerPreemptions;

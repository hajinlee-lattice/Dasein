...
public class DefaultYarnClientCustomization extends YarnClientCustomization {
    ...
    public List<String> getCommands(Properties containerProperties, Properties appMasterProperties) {
        ...
        return Arrays.<String> asList(new String[] { "$JAVA_HOME/bin/java", //
                ...
                "-XX:+UseG1GC -XX:+UseStringDeduplication -XX:+PrintGCDetails -XX:+PrintGCTimeStamps -XX:+PrintGCDateStamps -XX:+PrintAdaptiveSizePolicy -Xloggc:<LOG_DIR>/gc.log -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=<LOG_DIR>/heapdump.log", //

...
public class KVTestNG extends DataFlowOperationFunctionalTestNGBase {
        ...
        for (GenericRecord record : output) {
            ...
            if (record.get(KEY_ATTR).equals("Attr1")) {
                if (new Long(5L).equals(record.get("RowId"))) {
                    Assert.assertEquals(record.get(KVDepivotStrategy.valueAttr(String.class)), null);
                } else {
            ...
            if (record.get(KEY_ATTR).equals("Attr2")) {
                if (new Long(4L).equals(record.get("RowId"))) {
                    Assert.assertEquals(record.get(KVDepivotStrategy.valueAttr(Double.class)), null);
                } else {
            ...
            if (record.get(KEY_ATTR).equals("Attr3")) {
                if (new Long(3L).equals(record.get("RowId"))) {
                    Assert.assertEquals(record.get(KVDepivotStrategy.valueAttr(Integer.class)), null);
                } else {
            ...
            if (record.get(KEY_ATTR).equals("Attr4")) {
                if (new Long(2L).equals(record.get("RowId"))) {
                    Assert.assertEquals(record.get(KVDepivotStrategy.valueAttr(Boolean.class)), null);
                } else {
                    Assert.assertEquals(record.get(KVDepivotStrategy.valueAttr(Boolean.class)), Boolean.TRUE);
                }
            }
            if (record.get(KEY_ATTR).equals("Attr5")) {
                if (new Long(5L).equals(record.get("RowId"))) {
                    Assert.assertEquals(record.get(KVDepivotStrategy.valueAttr(String.class)), "only me");
                } else {
                    Assert.assertEquals(record.get(KVDepivotStrategy.valueAttr(Boolean.class)), null);
                }
            }
    ...
    private void uploadTwoTableAvro() {
        Object[][] data = new Object[][] { //
                { "1", 1.0, 1, true, "2", 2.0, 2, false, 1L }, // all from table 1
                { null, 1.0, 1, true, "2", 2.0, 2, false, 2L }, // attr1 from  table 2
                { "1", null, 1, true, "2", 2.0, 2, false, 3L }, // attr2 from table 2
                { "1", 1.0, null, true, "2", 2.0, 2, false, 4L }, // attr3 from table 2
                { "1", 1.0, 1, null, "2", 2.0, 2, false, 5L }, // attr4 from table 2
        };

...
public class DataFlowServiceImplTestNG extends DataFlowFunctionalTestNGBase {
    ...
    public void setup() throws Exception {
        String jarFile = ClassLoader.getSystemResource(
                "com/latticeengines/dataflow/service/impl/le-serviceflows-prospectdiscovery.jar").getPath();
        HdfsUtils.rmdir(yarnConfiguration, //
                String.format("%s/%s", SoftwareLibraryService.TOPLEVELPATH, "dataflow"));

...
public class RedshiftFactory extends JDBCFactory
  ...
  public Scheme createScheme( String format, Fields fields, Properties formatProperties )
    {
    LOG.info( String.format("creating RedshiftScheme for format %s with fields %s and properties %s", format, fields, formatProperties ));
  ...
  public Tap createTap( String protocol, Scheme scheme, String identifier, SinkMode sinkMode, Properties protocolProperties )
    ...
    return new RedshiftTap( identifier, jdbcUser, jdbcPassword, null, hfsStagingDir, credentials, redshiftTableDesc, (RedshiftScheme) scheme, sinkMode, keepDebugHdfsData, useDirectInsert );
    }

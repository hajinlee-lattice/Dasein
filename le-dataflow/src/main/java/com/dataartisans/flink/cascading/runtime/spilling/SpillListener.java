...
public class SpillListener implements Spillable.SpillListener {
    ...
    public void notifyWriteSpillBegin(Spillable spillable, int spillSize, String spillReason) {
        ...
        if (numFiles % 10 == 0) {
            LOG.info(
                    "spilling class: {}, spilling group: {}, on grouping: {}, num times: {}, with reason: {}",
            ...
            LOG.info("spilling class: {}, mem on spill (mb), free: " + freeMem + ", total: "
                    + totalMem + ", max: " + maxMem, this.splillingClazz.getSimpleName());
        }

...
public class CoGroupBufferReducer
        extends RichGroupReduceFunction<Tuple3<Tuple, Integer, Tuple>, Tuple> {
        ...
        try {
            ...
            if (sources.size() != 1) {
                throw new RuntimeException(
                        "FlowNode for CoGroupBufferReducer may only have a single CoGroup source");
            }
            ...
            throw new FlowException("internal error during CoGroupBufferReducer configuration",
                    throwable);
        }
    ...
    @Override
    public void reduce(Iterable<Tuple3<Tuple, Integer, Tuple>> input, Collector<Tuple> output)
            throws Exception {
        ...
        try {
            ...
            throw new FlowException("internal error during CoGroupBufferReducer execution",
                    throwable);
        }

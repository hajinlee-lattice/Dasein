...
public class CoGroupReduceStreamGraph extends NodeStreamGraph {
    ...
    protected Duct createBoundaryStage(Boundary boundary, IORole role) {
        ...
        throw new IllegalArgumentException(
                "Boundary may only be used sink in CoGroupReduceStreamGraph");
    }

    @Override
    protected Gate createCoGroupGate(CoGroup coGroup, IORole ioRole) {
        throw new UnsupportedOperationException(
                "Cannot create a CoGroup gate in a CoGroupReduceStreamGraph");
    }

    @Override
    protected Gate createGroupByGate(GroupBy groupBy, IORole ioRole) {
        throw new UnsupportedOperationException(
                "Cannot create a GroupBy gate in a CoGroupReduceStreamGraph");
    }

...
public class NaryHashJoinJoiner extends RichFlatJoinFunction<Tuple2<Tuple, Tuple[]>, Tuple, Tuple> {
     ...
     *
     */
    private static final long serialVersionUID = 5850920251017089836L;
    ...
    public void open(Configuration config) {
        ...
        try {
            ...
            throw new FlowException("internal error during NaryHashJoinJoiner configuration",
                    throwable);
        }
    ...
    @Override
    public void join(Tuple2<Tuple, Tuple[]> left, Tuple right, Collector<Tuple> output)
            throws Exception {
        ...
        try {
            ...
            throw new FlowException("internal error during NaryHashJoinJoiner execution",
                    throwable);
        }
    }

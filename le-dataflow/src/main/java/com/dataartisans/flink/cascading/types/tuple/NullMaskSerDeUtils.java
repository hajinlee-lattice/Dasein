...
public class NullMaskSerDeUtils {
    ...
    public static void writeNullMask(Tuple t, DataOutputView target) throws IOException {
    ...
    public static void writeNullMask(Object[] array, int length, DataOutputView target)
            throws IOException {
    ...
    public static void readNullMask(boolean[] mask, int length, DataInputView source)
            throws IOException {
    ...
    public static void readAndCopyNullMask(boolean[] mask, int length, DataInputView source,

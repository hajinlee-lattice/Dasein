...
public class EncodedAttributeHandler {
    ...
    public void handleEncodedAttribute(Map<String, Map<String, Long[]>> binaryCodedBuckets,
            Object obj, String fieldName, String encodedNoKey, String encodedYesKey,
        ...
        try {
            ...
            if (binaryCodedBuckets.get(fieldName) == null) {
                initYesNoArrays(binaryCodedBuckets, fieldName, encodedNoKey, encodedYesKey,
                        decodedBooleanArray);
            }
            ...
            if (yesCountArray.length < decodedBooleanArray.length) {
                readjustYesNoArrays(binaryCodedBuckets, fieldName, encodedNoKey, encodedYesKey,
                        decodedBooleanArray, yesCountArray, noCountArray);
    ...
    private void readjustYesNoArrays(Map<String, Map<String, Long[]>> binaryCodedBuckets,
            String fieldName, String encodedNoKey, String encodedYesKey,
            boolean[] decodedBooleanArray, Long[] yesCountArray, Long[] noCountArray) {
    ...
    private void initYesNoArrays(Map<String, Map<String, Long[]>> binaryCodedBuckets,
            String fieldName, String encodedNoKey, String encodedYesKey,
            boolean[] decodedBooleanArray) {

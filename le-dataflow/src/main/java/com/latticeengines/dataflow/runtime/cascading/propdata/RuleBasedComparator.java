...
public class RuleBasedComparator {
    ...
    public static int preferLargerLongWithThreshold(Long checking, Long checked, long threshold, long gap) {
    ...
    public static int preferEqualStrings(String checking1, String checking2, String checked1, String checked2) {

...
public class TypeConvertFunction extends BaseOperation implements Function {
    ...
    public TypeConvertFunction(String field, TypeConvertStrategy strategy, boolean failForCastError) {
    ...
    public void operate(FlowProcess flowProcess, FunctionCall functionCall) {
        ...
        case STRING_TO_LONG:
            ...
            try {
                ...
                if (failForCastError) {
                    throw new RuntimeException(String.format("Fail to cast field %s with value %s to Long", this.field,

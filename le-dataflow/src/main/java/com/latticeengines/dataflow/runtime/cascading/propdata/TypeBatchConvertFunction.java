...
public class TypeBatchConvertFunction extends BaseOperation implements Function {
    private static final Logger log = LoggerFactory.getLogger(TypeBatchConvertFunction.class);
            ...
            if (loc != null && loc >= 0) {
                ...
                case ANY_TO_INT:
                    ...
                    try {
                        ...
                        String msg = String.format("Fail to cast field %s with value %s to Integer", entry.getKey(),
                                TypeConversionUtil.toString(objVal));
                        if (failForCastError) {
                ...
                case ANY_TO_LONG:
                    ...
                    try {
                        ...
                        String msg = String.format("Fail to cast field %s with value %s to Long", entry.getKey(),
                                TypeConversionUtil.toString(objVal));
                        if (failForCastError) {
                            throw new RuntimeException(msg, e);
                        }
                ...
                case ANY_TO_DOUBLE:
                    ...
                    try {
                        ...
                        String msg = String.format("Fail to cast field %s with value %s to Double", entry.getKey(),
                                TypeConversionUtil.toString(objVal));
                        if (failForCastError) {
                            throw new RuntimeException(msg, e);
                        }
                ...
                case ANY_TO_BOOLEAN:
                    ...
                    try {
                        ...
                        String msg = String.format("Fail to cast field %s with value %s to Boolean", entry.getKey(),
                                TypeConversionUtil.toString(objVal));
                        if (failForCastError) {
                            throw new RuntimeException(msg, e);
                        }

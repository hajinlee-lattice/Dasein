...
public class AMSeedOrphanRecordWithDomainBuffer extends BaseOperation implements Buffer {
    private static final Logger log = LoggerFactory
            .getLogger(AMSeedOrphanRecordWithDomainBuffer.class);
    ...
    public AMSeedOrphanRecordWithDomainBuffer(Fields fieldDeclaration) {

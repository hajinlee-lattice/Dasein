...
import static com.latticeengines.domain.exposed.datacloud.dataflow.BucketAlgorithm.DATE;
import static com.latticeengines.domain.exposed.datacloud.dataflow.BucketAlgorithm.DISCRETE;
import static com.latticeengines.domain.exposed.datacloud.dataflow.BucketAlgorithm.INTERVAL;
...
@JsonSubTypes({ @JsonSubTypes.Type(value = CategoricalBucket.class, name = CATEGORICAL),
        @JsonSubTypes.Type(value = IntervalBucket.class, name = INTERVAL),
        ...
        @JsonSubTypes.Type(value = DateBucket.class, name = DATE) })

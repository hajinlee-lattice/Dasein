...
public class CustomizationProperty {
    ...
    public void setPropertyName(String propertyNameString) {
        CustomizationPropertyName propertyName = CustomizationPropertyName
                .fromName(propertyNameString);
        if (propertyName == null) {
            throw new RuntimeException(
                    String.format("No such CustomizationProperty %s", propertyNameString));
        }

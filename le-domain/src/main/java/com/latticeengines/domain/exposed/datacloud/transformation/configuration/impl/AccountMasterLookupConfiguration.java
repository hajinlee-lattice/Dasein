...
public class AccountMasterLookupConfiguration extends BasicTransformationConfiguration implements TransformationConfiguration {

    private String sourceName;
    private String version;
    private Map<String, String> sourceConfigurations;
    private String serviceBeanName = "accountMasterLookupRefreshService";
    private String rootOperationId;
    private List<SourceColumn> sourceColumns;
    private AccountMasterLookupInputSourceConfig inputSourceConfig;
    ...
    public void setAccountMasterLookupInputSourceConfig(AccountMasterLookupInputSourceConfig inputSourceConfig) {

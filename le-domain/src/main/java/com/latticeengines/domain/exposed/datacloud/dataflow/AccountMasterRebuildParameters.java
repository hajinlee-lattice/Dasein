...
public class AccountMasterRebuildParameters extends DataFlowParameters {
    ...
    public String getDunsKey() { return dunsKey; }

    public void setDunsKey(String dunsKey) { this.dunsKey = dunsKey; }
    ...
    public List<AccountMasterSourceParameters> getSourceParameters() { return sourceParameters; }

    public void setSourceParameters(List<AccountMasterSourceParameters> sourceParameters) { this.sourceParameters = sourceParameters; }

    public String getLastSource() { return lastSource; }

    public void setLastSource(String lastSource) { this.lastSource = lastSource; }

    public String[] getSeedFields() { return seedFields; }

    public void setSeedFields(String[] seedFields) { this.seedFields = seedFields; }
}

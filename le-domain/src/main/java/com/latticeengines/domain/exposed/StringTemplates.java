...
public class StringTemplates {
    ...
    public static final String ACTIVITY_METRICS_GROUP_TOTAL_VISIT_DESCRIPTION = "Number of visits to ${PathPatternId.PathPatternName} ${" + ACTIVITY_METRICS_GROUP_TIME_RANGE_TOKEN + "}";

    public static final String ACTIVITY_METRICS_GROUP_SUBCATEGORY = "${PathPatternId.PathPatternName}";

    public static final String ACTIVITY_METRICS_GROUP_SOURCEMEDIUM_DISPLAYNAME = "Visits from <#if SourceMediumId.SourceMedium == '__others__'>all other sources<#else>${SourceMediumId.SourceMedium}</#if> ${" + ACTIVITY_METRICS_GROUP_TIME_RANGE_TOKEN + "}" ;

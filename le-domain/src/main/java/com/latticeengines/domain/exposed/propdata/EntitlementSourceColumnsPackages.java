...
public class EntitlementSourceColumnsPackages implements HasPid, HasPackageName{
    ...
    @Override
    @JsonIgnore
    public void setPackageName(String SourceColumnsPackageName) {
        this.SourceColumnsPackageName = SourceColumnsPackageName;
    }
}

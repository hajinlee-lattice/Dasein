...
public class AccountMasterSeedRebuildFlowParameter extends DataFlowParameters {
    ...
    private List<List<String>> baseSourcePrimaryKeys;
    ...
    public List<List<String>> getBaseSourcePrimaryKeys() {
        return baseSourcePrimaryKeys;
    }

    public void setBaseSourcePrimaryKeys(List<List<String>> baseSourcePrimaryKeys) {
        this.baseSourcePrimaryKeys = baseSourcePrimaryKeys;
    }

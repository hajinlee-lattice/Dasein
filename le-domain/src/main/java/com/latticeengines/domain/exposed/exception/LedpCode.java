...
public enum LedpCode {
    ...
    LEDP_18235(
            "RegisterDeleteDataTemplate is the only supported schema for delete operation with entity match tenant! Not {0}"), //
    ...
    LEDP_18241("Team name \"{0}\" already exists in tenant {1}."), //
    ...
    LEDP_18252("All records in {0} role has been deleted!"), //
    ...
    LEDP_39010("Invalid ID value ({0}) for {1} :CustomerSpace {2}"), //

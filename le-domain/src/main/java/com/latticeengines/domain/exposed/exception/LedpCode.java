...
public enum LedpCode {
    ...
    LEDP_18024(
            ...
            LEDP_18089(
                    ...
                    LEDP_18095(
                            "Detected unexpected character in header name {0}, in csv file {1}."), //
    ...
    LEDP_20009(
            ...
            LEDP_20010(
                    ...
                    LEDP_20011(
                            "The scoring python script (scoring.py) failed, with the error message: {0}.}"), //
            ...
            LEDP_21010(
                    ...
                    LEDP_21012(
                            ...
                            LEDP_21014(
                                    ...
                                    LEDP_21015(
                                            "Problem getting group status via DataLoader REST: {0}"), //
                                            LEDP_21016(
                                                    "Problem getting group last success time: there is no success launch in DL."), //
                                                    LEDP_21017(
                                                            "Problem getting group last failure launch: there is no failure launch in DL."), //
                                                            LEDP_21018(
                                                                    "Problem canceling launch via DataLoader REST; DataLoader result code: {0}, error message: {1}"), //
                                                                    LEDP_21019(
                                                                            "Problem canceling launch via DataLoader REST: {0}"), //
                                                                            LEDP_21020(
                                                                                    "Problem running query via DataLoader REST; DataLoader error message: {0}"), //
                                                                                    LEDP_21021(
                                                                                            "Problem running query via DataLoader REST: {0}"), //
                                                                                            LEDP_21022(
                                                                                                    "Problem getting query status via DataLoader REST; DataLoader error message: {0}"), //
                                                                                                    LEDP_21023(
                                                                                                            "Problem getting query status via DataLoader REST: {0}"), //
                                                                                                            LEDP_21024(
                                                                                                                    "Problem getting query result data via DataLoader REST; DataLoader error message: {0}"), //
                                                                                                                    LEDP_21025(
                                                                                                                            "Problem getting query result data via DataLoader REST: {0}"), //
                                                                                                                            LEDP_21026(
                                                                                                                                    "Problem getting source table metadata via DataLoader REST; DataLoader error message: {0}"), //
                                                                                                                                    LEDP_21027(
                                                                                                                                            "Problem getting source table metadata via DataLoader REST: {0}"), //
    ...
    LEDP_28013(
            ...
            LEDP_28018(
                    "Workflow execution {0} cannot be restarted since in non-terminated state:{1}"), //

...
public final class DataCloudConstants {
    ...
    public static final String TRANSFORMER_COPY_TXFMR = "CopyTxfmr";
    ...
    public static final String TRANSFORMER_CHANGELIST_TXFMR = "ChangeListTxfmr";
    public static final String TRANSFORMER_REPORT_CHANGELIST_TXFMR = "ReportChangeListTxfmr";
    ...
    public static final String TRANSFORMER_GENERATE_CURATED_ATTRIBUTES = "GenerateCuratedAttrsTxfmr";

...
public enum MatchCommandStatus {
    ...
    UNKNOWN("UNKNOWN"), NOT_FOUND("NOT FOUND"), NEW("NOT STARTED"), MATCHING("MATCHING"), MATCHED(
            "MATCHED"), PROCESSED("PROCESSED"), COMPLETING(
                    "COMPLETING"), COMPLETE("COMPLETE"), ABORTED("ABORTED"), FAILED("FAILED");
    ...
    MatchCommandStatus(String status) {

...
public class FlowDefinition {
    ...
    public FlowDef getOrderSumDailyFlow() {
        ...
        Tap inTapFile = new Hfs(new TextDelimited(true, cascadingInputDelimiter), cascadingInpath + "/" + orderSummary + dataInputFileType);
        Tap outTapFile = new Hfs(new TextDelimited(true, ","), dataHadoopRootPath + dataHadoopWorkingPath + "/" + orderSummary,SinkMode.UPDATE);
    ...
    public FlowDef getOrderDetailDailyFlow() {
        ...
        Tap inTapFile = new Hfs(new TextDelimited(true, cascadingInputDelimiter), cascadingInpath + "/" + orderDetail + dataInputFileType);
        Tap outTapFile = new Hfs(new TextDelimited(true, ","), dataHadoopRootPath + dataHadoopWorkingPath + "/" + orderDetail,SinkMode.UPDATE);
    ...
    public FlowDef getShipDailyFlow() {
        ...
        Tap inTapFile = new Hfs(new TextDelimited(true, cascadingInputDelimiter), cascadingInpath + "/" + shipToAddrLattice + dataInputFileType);
        Tap outTapFile = new Hfs(new TextDelimited(true, ","), dataHadoopRootPath + dataHadoopWorkingPath + "/" + shipToAddrLattice,SinkMode.UPDATE);
    ...
    public FlowDef getWarrantyDailyFlow() {
        ...
        Tap inTapFile = new Hfs(new TextDelimited(true, cascadingInputDelimiter), cascadingInpath + "/"  + warrantyGlobal + dataInputFileType);
        Tap outTapFile = new Hfs(new TextDelimited(true, ","), dataHadoopRootPath + dataHadoopWorkingPath + "/" + warrantyGlobal,SinkMode.UPDATE);

...
public class TestBasePostprocessingStepConfiguration extends BaseStepConfiguration {

    public TestBasePostprocessingStepConfiguration() {}

    public TestBasePostprocessingStepConfiguration(String stepBeanName) {

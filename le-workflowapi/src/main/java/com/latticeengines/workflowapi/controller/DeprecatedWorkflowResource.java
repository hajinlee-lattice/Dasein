...
public class DeprecatedWorkflowResource implements DeprecatedWorkflowInterface {

    private static final Logger log = LoggerFactory.getLogger(DeprecatedWorkflowResource.class);

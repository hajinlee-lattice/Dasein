...
public interface EMRService {
    ...
    List<Instance> getRunningInstancesInGroup(String clusterId, String groupId, int limit);

    List<Instance> getRunningInstancesInFleet(String clusterId, String fleetId, int limit);

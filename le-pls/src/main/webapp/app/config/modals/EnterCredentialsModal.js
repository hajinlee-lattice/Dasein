...
.controller('EnterCredentialsController', function ($scope, ResourceUtility, StringUtility, EnterCredentialsModal, GriotConfigService) {
    ...
    $scope.saveClicked = function () {
        ...
        if (areCredentialsValid() && !$scope.validateInProgess) {
            ...
            GriotConfigService.ValidateApiCredentials(apiObj).then(function(data) {
                $scope.validateInProgess = false;

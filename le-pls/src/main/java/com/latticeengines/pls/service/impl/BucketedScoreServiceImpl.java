...
public class BucketedScoreServiceImpl implements BucketedScoreService {
    ...
    private static final Log log = LogFactory.getLog(BucketedScoreServiceImpl.class);
    ...
    public BucketedScoreSummary getBucketedScoreSummaryForModelId(String modelId) throws Exception {
        ...
        for (int i = 99; i > 4; i--) {
            ...
            if (pivotedRecord != null && (int) pivotedRecord.get(SCORE) == i) {
                bucketedScoreSummary.getBucketedScores()[i] = new BucketedScore(
                ...
                bucketedScoreSummary.getBucketedScores()[i] = new BucketedScore(i, 0, 0,
                        cumulativeNumLeads, cumulativeNumConverted);
            }
        }

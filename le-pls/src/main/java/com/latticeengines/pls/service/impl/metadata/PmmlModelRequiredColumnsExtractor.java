...
@Component("pmmlModelRequiredColumnsExtractor")
public class PmmlModelRequiredColumnsExtractor extends GetRequiredColumns {
    
    @SuppressWarnings("unused")
    private static final Log log = LogFactory.getLog(PmmlModelRequiredColumnsExtractor.class);
    ...
    protected PmmlModelRequiredColumnsExtractor() {
    ...
    private DataComposition getDataComposition(ModelSummary summary) throws IOException {
        ...
        List<String> datacomposition = HdfsUtils.getFilesForDirRecursive(yarnConfiguration, modelIdDir.get(0), new HdfsFileFilter() {
        ...
        return JsonUtils.deserialize(HdfsUtils.getHdfsFileContents(yarnConfiguration, datacomposition.get(0)), DataComposition.class);
    }

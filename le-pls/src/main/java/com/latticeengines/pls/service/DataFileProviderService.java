...
public interface DataFileProviderService {
    ...
    void downloadPivotFile(HttpServletRequest request, HttpServletResponse response, String modelId,
    ...
    void downloadFileByPath(HttpServletRequest request, HttpServletResponse response,

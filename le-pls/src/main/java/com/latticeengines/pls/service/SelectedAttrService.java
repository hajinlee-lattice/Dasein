...
public interface SelectedAttrService {
    ...
    void save(LeadEnrichmentAttributesOperationMap attributes, Tenant tenant,
            Map<String, Integer> limitationMap);

    List<LeadEnrichmentAttribute> getAttributes(Tenant tenant, String attributeDisplayNameFilter,
    ...
    void downloadAttributes(HttpServletRequest request, HttpServletResponse response,

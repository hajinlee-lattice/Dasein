...
public class DropBoxResource {
    ...
    private static final String GET_DROPBOX_SUCCESS_MSG = "<p>Existing credentials. Please save them in a secure location."
            ...
            + "<p>AWS Region:</p><p><strong>%s</strong></p><p>Bucket:</p><p><strong>%s</strong></p><p>Drop Folder:</p><p><strong>%s</strong></p><p>Tenant:</p><p><strong>%s</strong></p><p>Generated by:</p><p><strong>%s</strong></p><br><p>To learn more about the automating the file imports, visit http://help.lattice-engines.com</p>";

...
public class BucketedScoreServiceTestUtils {
    ...
    public static BucketMetadata[] bucketMetadata1 = new BucketMetadata[] { BUCKET_METADATA_A, BUCKET_METADATA_B,
            BUCKET_METADATA_C, BUCKET_METADATA_D };
    public static BucketMetadata[] bucketMetadata2 = new BucketMetadata[] { BUCKET_METADATA_A_1, BUCKET_METADATA_B_1,
            BUCKET_METADATA_C_1, BUCKET_METADATA_D_1, BUCKET_METADATA_E_1 };

    public static ModelSummary createModelSummary(String modelId) throws Exception {

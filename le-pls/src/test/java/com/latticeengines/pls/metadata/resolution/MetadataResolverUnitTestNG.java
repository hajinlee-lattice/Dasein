...
public class MetadataResolverUnitTestNG {
    ...
    public void testTypeParse() {
        ...
        // case 9: for unified date time format M/d/yyyy H:m:s => MM/DD/YYYY
        // 00:00:00 24H
        ...
        // case 10: same times for M/d/yyyy H:m:s and M/d/yyyy H-m-s, M/d/yyyy
        // H:m:s wins => MM/DD/YYYY 00:00:00 24H
        Assert.assertTrue(metadataResolver.isDateTypeColumn(
        ...
        // case 11: same times for M/d/yyyy and M/d/yyyy H-m-s, M/d/yyyy H-m-s
        // wins => MM/DD/YYYY 00-00-00 24H
        Assert.assertTrue(metadataResolver.isDateTypeColumn(
        ...
        // case 13: same times for M/d/yyyy and M/d/yyyy H-m-s a, M/d/yyyy H-m-s
        // a => MM/DD/YYYY 00-00-00 12H wins.
        Assert.assertTrue(metadataResolver.isDateTypeColumn(
                Arrays.asList("11/4/2016", "12/05/2018", "11/4/2016 4-20-10 AM", "12/05/2018 6-10-20 PM"),
                formatForDateAndTime));
        Assert.assertEquals(formatForDateAndTime.getLeft(), "MM/DD/YYYY");
        ...
        Assert.assertEquals(formatForDateAndTime.getMiddle(), "00:00:00 24H");
        Assert.assertEquals(formatForDateAndTime.getRight(), "ISO 8601");

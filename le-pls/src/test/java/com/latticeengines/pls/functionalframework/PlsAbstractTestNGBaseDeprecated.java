...
public abstract class PlsAbstractTestNGBaseDeprecated extends SecurityFunctionalTestNGBase {
    ...
    protected static Tenant mainTestTenant;
    ...
    protected void loginTestingUsersToMainTenant() {
        ...
        if (testingUserSessions == null || testingUserSessions.isEmpty()) {
            ...
            for (AccessLevel level : AccessLevel.values()) {
                UserDocument uDoc = loginAndAttach(level, mainTestTenant);

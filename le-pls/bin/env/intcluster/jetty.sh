...
JAVA_OPTIONS=(-XX:MaxPermSize=2048m -Dcom.latticeengines.registerBootstrappers=true -Djetty.class.path=$JAVA_HOME/lib/tools.jar:$HADOOP_HOME/hadoop-common.jar:/etc/hadoop/conf.empty -DPLS_PROPDIR=/etc/ledp -Djavax.net.ssl.trustStore=/etc/ledp/ga209-ldap.dev.lattice.local.jks)

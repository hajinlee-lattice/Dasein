...
JAVA_OPTIONS=(-XX:MaxPermSize=2048m -Djetty.class.path=$JAVA_HOME/lib/tools.jar:$HADOOP_HOME/hadoop-common.jar:/etc/hadoop/conf.empty -DPLS_PROPDIR=/etc/ledp -DADMIN_PROPDIR=/etc/ledp -Djavax.net.ssl.trustStore=/etc/ledp/ga209-ldap.dev.lattice.local.jks -Xdebug -agentlib:jdwp=transport=dt_socket,address=4000,server=y,suspend=n)

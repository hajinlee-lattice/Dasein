...
JAVA_OPTIONS=(-XX:MaxPermSize=2048m -Djetty.class.path=$JAVA_HOME/lib/tools.jar:$HADOOP_HOME/hadoop-common.jar:/etc/hadoop/conf.empty -DPLS_PROPDIR=/etc/ledp -DADMIN_PROPDIR=/etc/ledp -Djavax.net.ssl.trustStore=/etc/ledp/bodcdevvcus209.dev.lattice.local.jks)

...
public class DataFeedTaskServiceImpl implements DataFeedTaskService {
    ...
    public void createDataFeedTask(String customerSpace, String dataFeedName, DataFeedTask dataFeedTask) {
        ...
        //mdService.createTable(CustomerSpace.parse(customerSpace), dataFeedTask.getImportTemplate());
        //dataFeedTask.setImportTemplate(mdService.getImportTable(CustomerSpace.parse(customerSpace), dataFeedTask
                //.getImportTemplate().getName()));
        dataFeedTaskEntityMgr.createDataFeedTask(dataFeedTask);
    }

    @Override
    public DataFeedTask getDataFeedTask(String customerSpace, String source, String dataFeedType, String entity, String dataFeedName) {
...
//        });
        ...
        dataFeedTask.getImportTemplate().setTableType(TableType.IMPORTTABLE);
        dataFeedTask.getImportTemplate().setTenant(tenant);
        //mdService.updateTable(CustomerSpace.parse(customerSpace), dataFeedTask.getImportTemplate());

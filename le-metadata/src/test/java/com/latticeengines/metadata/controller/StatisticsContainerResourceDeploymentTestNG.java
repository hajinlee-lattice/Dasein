...
public class StatisticsContainerResourceDeploymentTestNG extends MetadataDeploymentTestNGBase {
    private static final Logger log = LoggerFactory.getLogger(StatisticsContainerResourceDeploymentTestNG.class);
    ...
    public void testCreate() {
        ...
        log.info("stats name = " + container.getName());
    }

...
class DanteDemoURLTest(unittest.TestCase):
    ...
    def testcase_1_VerifyTalkingPoints(self):
        ...
        infos_TalkingPoints_Expected = danteData_TalkingPoints.GetPRODExpectedTalkingPoints('.\DanteUI\Config\ExpectedResult.xml')
    ...
    def testcase_2_VerifyBuyingSignal(self):
        ...
        infos_BuingSignal_Expected = danteData_BuyingSignal.GetPRODExpectedBuyingSingal('.\DanteUI\Config\ExpectedResult.xml')
...
class DanteInSFDCTest(unittest.TestCase):
    ...
    def testcase_1_VerifyTalkingPoints(self):
        ...
        danteData_TalkingPoints=DanteDataHelper()
        TP_infos_expected=danteData_TalkingPoints.GetPRODExpectedTalkingPoints('.\DanteUI\Config\ExpectedResult.xml')
        dantePage_TalkingPoints.Close_browser()

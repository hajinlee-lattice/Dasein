...
from Env.TestConfigs import ConfigCSV
from Env.TestConfigs import ConfigDLC
from Env.TestConfigs import EtlConfig
...
class JamsRunner(SessionRunner):
    ...
    def setJamsTenant(self,bard_name,queue_name=None):
        ...
        dlc = SessionRunner()
        if queue_name == None:
            queue = PLSEnvironments.pls_server[0:PLSEnvironments.pls_server.find(".")];
        else:
            queue=queue_name;

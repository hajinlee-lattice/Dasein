...
def ImportDanteSampleDate():
    ...
    if(args.sql_file=='ALL'):
        print 'import all 4 dante table'  
        files_paths.append('..\Data\sql_AccountCache.sql')
        files_paths.append('..\Data\sql_FECModelSummary.sql')
        files_paths.append('..\Data\sql_LeadCache.sql')
        files_paths.append('..\Data\sql_TalkingPoints.sql')        
    else:
        files_paths.append(args.sql_file)
    for file_path in files_paths:
        newfilepath=CreateFinalImplementsqlfile(file_path,args.replace_db_name,args.replace_customer_ID)

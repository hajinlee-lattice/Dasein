...
public class AuthPolicy {
    ...
    public AuthPolicy(String principalId, PolicyDocument policyDocumentObject, String apiKey) {
        this(principalId, policyDocumentObject);
        this.usageIdentifierKey = apiKey;
    }

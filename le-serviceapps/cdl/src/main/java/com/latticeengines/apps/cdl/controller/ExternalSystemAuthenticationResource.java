...
@RestController
@RequestMapping("/customerspaces/{customerSpace}/external-system-authentication")
public class ExternalSystemAuthenticationResource {
    ...
    public ExternalSystemAuthentication createAuthentication(@PathVariable String customerSpace,
            @RequestBody ExternalSystemAuthentication externalSystemAuthentication) {
    ...
    public ExternalSystemAuthentication updateAuthentication(@PathVariable String customerSpace,
            @PathVariable String authId, @RequestBody ExternalSystemAuthentication externalSystemAuthentication) {
    ...
    public List<ExternalSystemAuthentication> findAuthenticationsByLookupIdMappings(@PathVariable String customerSpace,
        ...
        return extSysAuthenticationService.findAuthenticationsByLookupMapIds(mappingIds);
    }
}

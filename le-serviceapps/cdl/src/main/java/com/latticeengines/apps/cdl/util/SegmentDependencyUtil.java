...
public class SegmentDependencyUtil {
    ...
    @NoCustomerSpace
    public void findSegmentDependingAttributes(MetadataSegment metadataSegment) {
    ...
    @NoCustomerSpace
    public Set<Restriction> getSegmentRestrictions(MetadataSegment metadataSegment) {

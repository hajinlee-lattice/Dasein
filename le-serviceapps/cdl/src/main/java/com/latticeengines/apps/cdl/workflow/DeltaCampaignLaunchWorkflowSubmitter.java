...
@Component("deltaCampaignLaunchWorkflowSubmitter")
public class DeltaCampaignLaunchWorkflowSubmitter extends WorkflowSubmitter {
    private static final Logger log = LoggerFactory.getLogger(DeltaCampaignLaunchWorkflowSubmitter.class);
    ...
    private Map<String, String> getContactDisplayNameMap(CDLExternalSystemType destinationSysType,
            LookupIdMap lookupIdMap) {
        if (destinationSysType != CDLExternalSystemType.FILE_SYSTEM && !lookupIdMap.isTrayAuthenticationSetUp()) {
            return null;
        }

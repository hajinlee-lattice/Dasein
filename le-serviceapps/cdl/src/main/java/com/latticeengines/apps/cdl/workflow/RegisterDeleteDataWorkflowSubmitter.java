...
public class RegisterDeleteDataWorkflowSubmitter extends WorkflowSubmitter {
    ...
    private Long createLegacyDeleteUploadAction(Tenant tenant,
        ...
        LegacyDeleteByUploadActionConfiguration legacyDeleteByUploadActionConfiguration = new LegacyDeleteByUploadActionConfiguration();
        legacyDeleteByUploadActionConfiguration.setEntity(businessEntity);
        legacyDeleteByUploadActionConfiguration.setTableName(cleanupByUploadConfiguration.getTableName());
        legacyDeleteByUploadActionConfiguration.setCleanupOperationType(cleanupByUploadConfiguration.getCleanupOperationType());
        legacyDeleteByUploadActionConfiguration.setFileDisplayName(cleanupByUploadConfiguration.getFileDisplayName());
        legacyDeleteByUploadActionConfiguration.setFileName(cleanupByUploadConfiguration.getFileName());
        legacyDeleteByUploadActionConfiguration.setFilePath(cleanupByUploadConfiguration.getFilePath());
        action.setActionConfiguration(legacyDeleteByUploadActionConfiguration);
        action.setTrackingPid(workflowPid);
        action.setTenant(tenant);
        if (tenant.getPid() != null) {
            MultiTenantContext.setTenant(tenant);

...
public class CDLJobServiceImplUnitTestNG {
    ...
    public void test_orchestrateJob() {
        ...
        Mockito.when(schedulingPAService.isSchedulerEnabled(anyString())).thenReturn(false);
    ...
    private void test_ClusterIDIsNotEmpty() {
        ...
        when(workflowProxy.queryByClusterIDAndTypesAndStatuses(anyString(), any(), anyList(), anyList(), any()))

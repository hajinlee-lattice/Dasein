...
public abstract class CDLEnd2EndDeploymentTestNGBase extends CDLDeploymentTestNGBase {
    ...
    // tenants (use ACCOUNT_PA_EM since checkpoint is not changed yet)
    ...
    static final Long DAILY_TXN_UT_EM = 51066L;
    ...
    static final Long PERIOD_TRANSACTION_UT_EM = 75652L;

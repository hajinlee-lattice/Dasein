...
public class AccountDataQuotaLimitDeploymentTestNG extends CDLEnd2EndDeploymentTestNGBase {
    ...
    private void importData() {
        ...
        importData(BusinessEntity.Account, accountCsv, null, false, false, null);
    ...
    protected void processAnalyze() {
        ...
        com.latticeengines.domain.exposed.workflow.Job Job = waitForWorkflow(appId.toString(),
                false);
    ...
    private void verifyNumAttrsInAccount() {
        ...
        log.info("account size is :" + cms.size());
        org.testng.Assert.assertTrue(cms.size() < 20000, "Should not have more than 20000 account attributes");
    }

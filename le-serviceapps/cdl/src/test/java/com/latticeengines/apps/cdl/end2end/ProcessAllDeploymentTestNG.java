...
import static com.latticeengines.apps.cdl.end2end.CheckpointService.CONTACT_IMPORT_SIZE_2;
import static com.latticeengines.apps.cdl.end2end.CheckpointService.CONTACT_IMPORT_SIZE_OVERLAP;
import static com.latticeengines.apps.cdl.end2end.CheckpointService.CONTACT_IMPORT_SIZE_TOTAL;
import static com.latticeengines.apps.cdl.end2end.CheckpointService.PRODUCT_IMPORT_SIZE_1;
import static com.latticeengines.apps.cdl.end2end.CheckpointService.PRODUCT_IMPORT_SIZE_2;
import static com.latticeengines.apps.cdl.end2end.CheckpointService.TRANSACTION_IMPORT_SIZE_1;
import static com.latticeengines.apps.cdl.end2end.CheckpointService.TRANSACTION_IMPORT_SIZE_2;
...
public class ProcessAllDeploymentTestNG extends CDLEnd2EndDeploymentTestNGBase {

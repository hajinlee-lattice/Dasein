...
public class EntityExportWorkflowWithEMDeploymentTestNG extends EntityExportWorkflowDeploymentTestNG {
    ...
    protected void verifyCsvGzHeder(Map<String, Integer> headerMap) {
        ...
        Assert.assertTrue(headerMap.containsKey("Contact ID"), "Header map: " + JsonUtils.serialize(headerMap));
        Assert.assertTrue(headerMap.containsKey("Account ID"), "Header map: " + JsonUtils.serialize(headerMap));

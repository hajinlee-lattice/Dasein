...
public class DeprecatedUpdateTransactionDeploymentTestNG extends CDLEnd2EndDeploymentTestNGBase {

    private static final Logger log = LoggerFactory.getLogger(DeprecatedUpdateTransactionDeploymentTestNG.class);

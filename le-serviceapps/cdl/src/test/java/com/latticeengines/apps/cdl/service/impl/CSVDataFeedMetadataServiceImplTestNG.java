...
public class CSVDataFeedMetadataServiceImplTestNG extends CDLFunctionalTestNGBase {
    ...
    public void testCompareMetadata() {
        Table sourceTable = SchemaRepository.instance().getSchema(BusinessEntity.Account, true, false, false, false);
        Table targetTable = SchemaRepository.instance().getSchema(BusinessEntity.Account, true, false, false, false);

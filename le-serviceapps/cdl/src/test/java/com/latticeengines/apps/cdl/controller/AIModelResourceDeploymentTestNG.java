...
public class AIModelResourceDeploymentTestNG extends AIModelServiceImplDeploymentTestNG {
    ...
    protected RatingModel getRatingModel() {
        ...
        RatingModel ratingModel = ratingEngineProxy.getRatingModel(mainTestTenant.getId(), aiRatingEngineId,
                aiRatingModelId);
        return ratingModel;
    }
    ...
    protected void deleteRatingEngine(RatingEngine ratingEngine) {
        ratingEngineProxy.deleteRatingEngine(mainTestTenant.getId(), ratingEngine.getId(), true, "test@lattice-engines.com");
    }
}

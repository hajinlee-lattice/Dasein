  ...
  BEGIN
    CREATE TABLE `DCP_PROJECT`
      (
         ...
         `PROJECT_DISPLAY_NAME` VARCHAR(255) DEFAULT NULL,
...
CREATE PROCEDURE `UpdatePLSTables`()
  BEGIN
    ALTER TABLE `PLS_MultiTenant`.`DANTE_PUBLISHEDTALKINGPOINT`
        ADD COLUMN `PLAY_ID` BIGINT(20) NOT NULL,
    ...
    ALTER TABLE `PLAY_LAUNCH`
        ...
        ADD COLUMN `DESTINATION_SYS_NAME` VARCHAR(255)  DEFAULT NULL AFTER `DESTINATION_SYS_TYPE`;

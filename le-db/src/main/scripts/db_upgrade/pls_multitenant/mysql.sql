...
ALTER TABLE `PLS_MultiTenant`.`METADATA_SEGMENT`  ADD COLUMN `ACCOUNT_CONTACT_OPERATOR` VARCHAR(255) NULL AFTER `NAME`, ADD COLUMN `CONTACT_RESTRICTION` LONGTEXT NULL AFTER `RESTRICTION`;

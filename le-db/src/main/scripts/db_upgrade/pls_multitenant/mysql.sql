...
CREATE PROCEDURE `UpdateSchema`()
  BEGIN
	  ...
	  ALTER TABLE `PLS_MultiTenant`.`EXPORT_FIELD_METADATA_DEFAULTS`
            ALTER `HISTORY_ENABLED` SET DEFAULT 0;

	  CREATE TABLE `DASHBOARD` (
        `DASHBOARD_PID` bigint(20) NOT NULL AUTO_INCREMENT,
        `DASHBOARD_URL` json NOT NULL,
        `NAME` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
        `FK_TENANT_ID` bigint(20) NOT NULL,
        PRIMARY KEY (`DASHBOARD_PID`),
        UNIQUE KEY `UK6un92bao008qok092mnitex9r` (`NAME`,`FK_TENANT_ID`),
        KEY `FK_DASHBOARD_FKTENANTID_TENANT` (`FK_TENANT_ID`),
        CONSTRAINT `FK_DASHBOARD_FKTENANTID_TENANT` FOREIGN KEY (`FK_TENANT_ID`) REFERENCES `TENANT` (`TENANT_PID`) ON DELETE CASCADE
      ...
      CREATE TABLE `DASHBOARD_FILTER` (
        ...
        `FK_TENANT_ID` bigint(20) NOT NULL,
        PRIMARY KEY (`PID`),
        UNIQUE KEY `UK8ew1uqkodj2fuhbhgvhf99q0w` (`NAME`,`FK_TENANT_ID`),
        KEY `FK_DASHBOARDFILTER_FKTENANTID_TENANT` (`FK_TENANT_ID`),
        CONSTRAINT `FK_DASHBOARDFILTER_FKTENANTID_TENANT` FOREIGN KEY (`FK_TENANT_ID`) REFERENCES `TENANT` (`TENANT_PID`) ON DELETE CASCADE
      ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

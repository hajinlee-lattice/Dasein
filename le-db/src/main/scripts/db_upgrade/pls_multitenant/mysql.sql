...
CREATE PROCEDURE `UpdateSchema`()
  BEGIN
	...
	alter table `DATAFEED_TASK_TABLE` add index FKF200D4CB5FC50F27 (FK_TABLE_ID), add constraint FKF200D4CB5FC50F27 foreign key (FK_TABLE_ID) references `METADATA_TABLE` (`PID`) on delete cascade;

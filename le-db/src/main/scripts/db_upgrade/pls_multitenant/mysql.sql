...
CREATE PROCEDURE `UpdatePLSTables`()
  BEGIN
    ...
    ALTER TABLE `PLAY_LAUNCH_CHANNEL`
        ...
        ADD COLUMN `FK_CURRENT_LAUNCH_UNIVERSE_TABLE` bigint,
        ADD CONSTRAINT `FK_PLAYLAUNCHCHANNEL_FKCURRENTLAUNCHUNIVERSETABLE_METADATATABLE`
            FOREIGN KEY (`FK_CURRENT_LAUNCH_UNIVERSE_TABLE`) REFERENCES `METADATA_TABLE` (`PID`) ON DELETE CASCADE;

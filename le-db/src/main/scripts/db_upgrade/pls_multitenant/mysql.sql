...
ALTER TABLE `PLS_MultiTenant`.`PLAY` ADD EXCLUDE_ACCOUNTS_WITHOUT_SFID boolean NOT NULL;
ALTER TABLE `PLS_MultiTenant`.`PLAY` ADD EXCLUDE_CONTACTS_WITHOUT_SFID boolean NOT NULL;

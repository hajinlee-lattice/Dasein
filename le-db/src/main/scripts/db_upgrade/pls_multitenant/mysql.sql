...
CREATE PROCEDURE `AddActionTable`()
    BEGIN
        create table `ACTION` (`PID` bigint not null auto_increment, `ACTION_INITIATOR` varchar(255) not null, `CREATED` datetime not null, `DESCRIPTION` longtext, `OWNER_ID` bigint, `TRACKING_ID` bigint, `TYPE` varchar(255) not null, `UPDATED` datetime not null, `FK_TENANT_ID` bigint not null, primary key (`PID`)) engine=InnoDB;

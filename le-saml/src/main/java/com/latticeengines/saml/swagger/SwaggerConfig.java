package com.latticeengines.saml.swagger;
...
public class SwaggerConfig {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder() //
                .title("Lattice Engines SAML REST API") //
                .description("This is the REST API exposed for the Lattice Engines SAML service.") //

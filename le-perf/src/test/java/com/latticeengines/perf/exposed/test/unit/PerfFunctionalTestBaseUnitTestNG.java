...
public class PerfFunctionalTestBaseUnitTestNG {
    ...
    public void init() throws Exception {
        ...
        // PropertiesConfiguration("hadoop-metrics2.properties").interpolatedConfiguration();
        // SubsetConfiguration subsetConfig = new SubsetConfiguration(conf,
        // "ledpjob.sink.file", ".");
        // sink = new SocketSink();
    ...
    @Test(groups = "unit", dependsOnMethods = { "beforeMethod" }, enabled = false)
    ...
    @Test(groups = "unit", dependsOnMethods = { "afterMethod" }, enabled = false)

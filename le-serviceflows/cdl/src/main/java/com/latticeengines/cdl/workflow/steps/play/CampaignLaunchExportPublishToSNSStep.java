...
public class CampaignLaunchExportPublishToSNSStep extends BaseWorkflowStep<PlayLaunchExportPublishToSNSConfiguration> {

    private static final Logger log = LoggerFactory.getLogger(CampaignLaunchExportPublishToSNSStep.class);
    ...
    public void execute() {
        ...
        String workflowRequestId = getStringValueFromContext(
                CampaignLaunchWorkflowConfiguration.RECOMMENDATION_WORKFLOW_REQUEST_ID);
    ...
    public PublishResult publishToSnsTopic(String customerSpace, String workflowRequestId) {
        ...
        Map<String, List<ExportFileConfig>> sourceFiles = //
                getFiles(CampaignLaunchWorkflowConfiguration.RECOMMENDATION_S3_EXPORT_FILE_PATHS);

...
public class CampaignLaunchExportFileGeneratorStep extends BaseWorkflowStep<PlayLaunchExportFilesGeneratorConfiguration> {

    private static final Logger log = LoggerFactory.getLogger(CampaignLaunchExportFileGeneratorStep.class);
    ...
    public void execute() {
        ...
        try (PerformanceTimer timer = new PerformanceTimer(
            ...
            putObjectInContext(CampaignLaunchWorkflowConfiguration.RECOMMENDATION_EXPORT_FILES, exportFiles);
        } catch (Exception e) {

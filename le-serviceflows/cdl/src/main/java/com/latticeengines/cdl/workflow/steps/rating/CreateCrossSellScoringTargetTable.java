...
@Component("createCrossSellScoringTargetTable")
@Scope(ConfigurableBeanFactory.SCOPE_PROTOTYPE)
public class CreateCrossSellScoringTargetTable extends BaseRedshiftIngestStep<GenerateRatingStepConfiguration> {

...
public class DeltaCampaignLaunchInitStep extends BaseSparkSQLStep<DeltaCampaignLaunchInitStepConfiguration> {
    ...
    private SparkJobResult executeSparkJob(PlayLaunchContext playLaunchContext,
        ...
        return retry.execute(ctx -> {
            ...
            try {
                ...
                return executeSparkJob(CreateDeltaRecommendationsJob.class, generateCreateDeltaRecommendationConfig(
                        accountDataUnit, contactDataUnit, playLaunchSparkContext));
            } finally {
                stopSparkSQLSession();
            }
        });
    ...
    private CreateDeltaRecommendationConfig generateCreateDeltaRecommendationConfig(HdfsDataUnit accountDataUnit,
            HdfsDataUnit contactDataUnit, PlayLaunchSparkContext playLaunchSparkContext) {
        CreateDeltaRecommendationConfig createRecConfig = new CreateDeltaRecommendationConfig();

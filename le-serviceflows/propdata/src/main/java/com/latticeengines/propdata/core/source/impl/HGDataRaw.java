...
public class HGDataRaw implements BulkSource {
    ...
    @Override
    public String getBulkStageTableName() {
        return "HG_Data_Customers";
    }

    @Override
    public StageServer getBulkStageServer() {
        return StageServer.COLLECTION_DB;
    }

    @Override
    public String getDownloadSplitColumn() {
        return "Date Last Verified";
    }

...
public class ParseMatchResultRefineAndCloneTestNG extends ServiceFlowsDataFlowFunctionalTestNGBase {
    ...
    public void test() {
        ...
        parameters.sourceColumns = Arrays.asList("InternalId", "Id", "Email", "Event", "CompanyName", "City", "State",
                "Country", "CreatedDate", "FirstName", "LastName", "Title", "IsClosed", "StageName", "PhoneNumber",
                "Industry", "avro_1to300", "Activity_Count_Click_Email", "Activity_Count_Click_Link",

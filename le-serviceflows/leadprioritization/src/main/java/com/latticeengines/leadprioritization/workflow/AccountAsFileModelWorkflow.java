...
@Component("accountAsFileModelWorkflow")
public class AccountAsFileModelWorkflow extends AbstractWorkflow<WorkflowConfiguration> {
    ...
    @Bean
    public Job accountAsFileModelWorkflowJob() throws Exception {

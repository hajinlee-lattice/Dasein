...
//
// playLaunchInitStep.setConfiguration(createConf(CustomerSpace.parse(tenantIdentifier),
// playId, playLaunchId));
// }
//
// @Test(groups = "unit")
...
// }
//
// private PlayLaunchInitStepConfiguration createConf(CustomerSpace
// customerSpace, String playName,
// String playLaunchId) {
// PlayLaunchInitStepConfiguration config = new
// PlayLaunchInitStepConfiguration();

...
public class SampleOutputRecord {

    private Integer rowNumber;
    private Boolean matched;
    private List<Object> input;
    private String matchedDomain;
    private SampleNameLocation matchedNameLocation;
    ...
    public SampleNameLocation getMatchedNameLocation() {
        return matchedNameLocation;
    }

    @JsonProperty("MatchedNameLocation")
    public void setMatchedNameLocation(SampleNameLocation matchedNameLocation) {

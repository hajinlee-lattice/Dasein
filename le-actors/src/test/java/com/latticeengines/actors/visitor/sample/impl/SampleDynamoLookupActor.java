...
public class SampleDynamoLookupActor extends SampleDataSourceWrapperActorTemplate {
    ...
    @Resource(name = "sampleDynamoDBLookupService")
    private SampleDataSourceLookupService dynamoDBLookupService;

    private static TimerRegistrationHelper timerRegistrationHelper = //
            new TimerRegistrationHelper(SampleDynamoLookupActor.class);

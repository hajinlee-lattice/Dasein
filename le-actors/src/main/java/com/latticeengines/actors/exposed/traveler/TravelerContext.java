...
public abstract class TravelerContext {
    ...
    public TravelerContext(String rootOperationUid, GuideBook guideBook) {
    ...
    public void updateVisitedHistoryInfo(String traversedActor) {

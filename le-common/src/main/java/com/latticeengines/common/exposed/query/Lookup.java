...
/**
 * Specifies one or more column or value lookups in a query. MAX(ColumnName)
 * would be {interpretation = [COLUMN], references = [ColumnName],
 * transformations = [MAX]} MAX(ColumnName) + 5 would be {interpretation =
 * [COLUMN, VALUE], references = [ColumnName, 5], transformations = [MAX, null],
 * formula = $0 + $1}
 */
public class Lookup {
    ...
    public Lookup(List<Object> references, List<ReferenceInterpretation> interpretations,

/*
 * This class needs to be overwritten because of incompatible bug that got introduced in spring-web-5.0.x-RELEASE
 * They started allowing '+' is QueryParameter, which is breaking Lattice application
 */

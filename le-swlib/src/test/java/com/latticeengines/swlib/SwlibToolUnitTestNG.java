...
public class SwlibToolUnitTestNG {
    ...
    public void main() throws Exception {
        String jarFile = ClassLoader.getSystemResource("com/latticeengines/swlib/le-serviceflows-prospectdiscovery.jar").getPath();
        SwlibTool.main(new String[] {
                "-o", "install", //
                "-m", "dataflow", //

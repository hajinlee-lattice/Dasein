...
def provision(environment, app, stackname, tgrp, profile, instance_type, tag="latest", init_cap=2, max_cap=8, public=False, le_stack=None, second_tgrp=None):
    ...
    max_mem = int(TYPE_DEF[instance_type]['mem_gb'] * 1024.0 - 1024)
...
def parse_args():
    ...
    parser1.add_argument('-e', dest='environment', type=str, default='dev', choices=['dev', 'qacluster','prodcluster', 'dr'], help='environment')

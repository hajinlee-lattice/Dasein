...
public class SingleRecordMeasurement extends BaseMeasurement<ScoreRequestMetrics, ScoreRequestMetrics>
        implements Measurement<ScoreRequestMetrics, ScoreRequestMetrics> {

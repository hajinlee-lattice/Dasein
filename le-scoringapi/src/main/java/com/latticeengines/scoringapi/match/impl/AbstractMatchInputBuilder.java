...
public abstract class AbstractMatchInputBuilder implements MatchInputBuilder {
    ...
    private void setMatchKeyMap(ModelSummary modelSummary, InterpretedFields interpreted, Map<String, Object> record,
        ...
        addToKeyMapIfValueExists(keyMap, MatchKey.Address, interpreted.getStreetAddress1(), record);
        addToKeyMapIfValueExists(keyMap, MatchKey.Address2, interpreted.getStreetAddress2(), record);

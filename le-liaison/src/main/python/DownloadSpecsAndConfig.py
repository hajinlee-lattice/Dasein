...
def downloadSpecsAndConfig(tenantName, fileNameBase):
  ...
  if type == 'ELQ':
    ...
    lg_mgr.createDataProvider('<dataProvider name="SQL_DanteDB_DataProvider" autoMatch="False" connectionString="ServerName=;Database=;User=;Password=;Authentication=Windows Authentication;Schema=dbo;BatchSize=2000" dbType="2" usedFor="1" e="False" />')

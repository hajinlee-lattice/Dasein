...
public class ModelResourceTestNG extends ApiFunctionalTestNGBase {
	...
	public void setup() throws Exception {
		...
		URL decisionTreePythonScriptUrl = ClassLoader.getSystemResource("com/latticeengines/api/controller/dt_train.py");
		URL logisticRegressionPythonScriptUrl = ClassLoader.getSystemResource("com/latticeengines/api/controller/lr_train.py");
	...
	public void submit() throws Exception {
		...
		AppSubmission submission = restTemplate.postForObject("http://localhost:8080/rest/submit", model, AppSubmission.class, new Object[] {});

...
public class UserResourceTestNG extends UserResourceTestNGBase {
    ...
    private static Object[][] authTableProvider() {
        return new Object[][] { //
                { AccessLevel.SUPER_ADMIN, new Boolean[]      {true,  true,  true, true,  true,  true,  true,  true,
                        true} },
                { AccessLevel.INTERNAL_ADMIN, new Boolean[]   {true,  true,  true, true,  true,  true,  true,  true,
                        false} },
                { AccessLevel.INTERNAL_USER, new Boolean[]    {false, false, false, false, false, false, false, false,
                        false} },
                { AccessLevel.EXTERNAL_ADMIN, new Boolean[]   {true,  true,  true, true,  true,  false, false, false,
                        false} },
                { AccessLevel.EXTERNAL_USER, new Boolean[]    {false, false, false, false, false, false, false, false,
                        false} },
                { AccessLevel.SALES,         new Boolean[]    {false, false,  false, false, false, false, false, false,
                        false} },
    ...
    public static Object[][] getAllUsersProvider() {
        return new Object[][] {
                { AccessLevel.SUPER_ADMIN, true, 9 },
                { AccessLevel.INTERNAL_ADMIN, true, 9 },

...
public class DashboardProxy extends MicroserviceRestApiProxy implements ProxyInterface {
    ...
    public Dashboard createDashboard(String customerSpace, Dashboard dashboard) {
        String url = constructUrl("/customerspaces/{customerSpace}/dashboard", shortenCustomerSpace(customerSpace));
    ...
    public void createDashboardList(String customerSpace, List<Dashboard> dashboardList) {
        String url = constructUrl("/customerspaces/{customerSpace}/dashboard/createList", shortenCustomerSpace(customerSpace));
    ...
    public List<DashboardFilter> getDashboardFilters(String customerSpace) {
        String url = constructUrl("/customerspaces/{customerSpace}/dashboard/getFilter", shortenCustomerSpace(customerSpace));

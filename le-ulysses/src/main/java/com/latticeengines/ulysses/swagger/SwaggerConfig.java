...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2) //
                .select() //
                .apis(SwaggerUtils.getApiSelector("com.latticeengines.ulysses.controller.*",
                        "com.latticeengines.app.exposed.controller.*")::test) //
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder() //
                .title("Lattice Engines Ulysses API") //
                .description("This is the REST API for ulysses services.") //

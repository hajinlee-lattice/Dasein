...
@Component("accountMasterStatsMinMaxTransformer")
public class AccountMasterStatsMinMaxTransformer
    ...
    public String getName() {
        return "accountMasterStatsMinMaxTransformer";
    }

    @Override
    protected String getDataFlowBeanName() {
        return "accountMasterStatsMinMaxFlow";
    }

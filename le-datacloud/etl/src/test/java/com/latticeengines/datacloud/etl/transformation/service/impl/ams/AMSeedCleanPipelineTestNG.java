    ...
    protected void verifyResultAvroRecords(Iterator<GenericRecord> records) {
        ...
        Object[][] expectedData = {
                ...
                { 1L, "a.com", "DUNS01", "Name01", "Country01", "DnB", "N", "Y", "0", ">10,000", 100, 100, 100000000L,
                        "DUNS01", "[Step=AMSeedCleanupTransformer,Code=FILTER,Log=Non-OOB]" },
                ...
                { 3L, "c.com", "DUNS01", "Name01", "Country01", "Orb", "Y", "Y", "0", ">10,000", 100, null, 100000000L,
                        "DUNS01",
                        "[Step=AMSeedMarkerTransformer,Code=IS_PRIMARY_DOMAIN,Log=DomainSource=Orb],[Step=AMSeedCleanupTransformer,Code=FILTER,Log=Non-OOB]" },
                // Compare alexa rank
                { 4L, "a.com", "DUNS02", "Name02", "Country02", "DnB", "N", "Y", "0", ">10,000", 100, 100, 100000000L,
                        "DUNS02", "[Step=AMSeedCleanupTransformer,Code=FILTER,Log=Non-OOB]" },
                { 5L, "b.com", "DUNS02", "Name02", "Country02", "DnB", "Y", "Y", "0", ">10,000", 100, 10, 100000000L,
                        "DUNS02",
                        "[Step=AMSeedMarkerTransformer,Code=IS_PRIMARY_DOMAIN,Log=Lower AlexaRank=10],[Step=AMSeedCleanupTransformer,Code=FILTER,Log=Non-OOB]" },
                ...
                { 7L, "j.com", "DUNS03", "Name03", "Country03", "RTS", "N", "Y", "0", ">10,000", 100, null, 100000000L,
                        "DUNS03", "[Step=AMSeedCleanupTransformer,Code=FILTER,Log=Non-OOB]" },
                { 8L, "k.com", "DUNS03", "Name03", "Country03", "HG", "Y", "Y", "0", ">10,000", 100, null, 100000000L,
                        "DUNS03",
                        "[Step=AMSeedMarkerTransformer,Code=IS_PRIMARY_DOMAIN,Log=DomainSource=HG],[Step=AMSeedCleanupTransformer,Code=FILTER,Log=Non-OOB]" },
                ...
                { 12L, "g.com", "DUNS04", "Name04", "Country04", null, "Y", "Y", "0", ">10,000", 100, null, 100000000L,
                        "DUNS04",
                        "[Step=AMSeedMarkerTransformer,Code=IS_PRIMARY_DOMAIN,Log=Original LE_IS_PRIMARY_DOMAIN=Y],[Step=AMSeedCleanupTransformer,Code=FILTER,Log=Non-OOB]" },
                // Domain-only entries
                ...
                { 16L, null, "DUNS06", "Name06", "Country06", null, "N", "Y", "0", ">10,000", 100, null, 100000000L,
                        "DUNS05", "[Step=AMSeedCleanupTransformer,Code=FILTER,Log=Non-OOB]" },

                /* Test markOOBEntries */
                { 113L, null, "47", "Name47", "Country47", "DnB", "N", "Y", null, ">10,000", 100, null, 100000000L,
                        "47", "[Step=AMSeedCleanupTransformer,Code=FILTER,Log=Non-OOB]" },

...
public class AMSeedManualFixTestNG
    ...
    private void prepareManualSeedData() {
        ...
        Object[][] data = new Object[][] {
                ...
                { "3", "", "DUNS48", "mulesoft.com", 8888880000L, 98688, ">10,000", "5-10B" },
                // all types of keys with Fix_DU_Tree_Flag = Y
                { "5", "Y", "DUNS67", "cjsc.com", 35970000000L, 10001, ">10,000", ">10B" },
                { "6", "Y", "DUNS88", "baidu.com", 5420000000L, 45763, ">10,000", "5-10B" },
                // testing Null value for employees field
                { "7", "Y", "DUNS13", "netflix.com", 8820000000L, null, null, "5-10B" },
    ...
    private void prepareAmSeedData() {
        ...
        Object[][] data = new Object[][] {
                ...
                { "21", "DUNS63", "sbi.com", "DUNS63", 3588555440L, 53273, "Y", "1-5B", ">10,000", "Tahoe" },
                ...
                { "6", "DUNS99", "intuit.com", "DUNS23", 3555555880L, 77773, "N", "1-5B", ">10,000", "Gilroy" },
                // testing NULL DU value
                { "9", null, "dsv.com", "DUNS88", 54208787870L, 44444, "Y", ">10B", ">10,000", "Foster City" },
                { "11", null, "dell.com", "DUNS34", 59444444470L, 13049, "Y", ">10B", ">10,000", "Fremont" },
                ...
                { "5", "DUNS99", "csx.com", "DUNS26", 35970088880L, 19843, "Y", ">10B", ">10,000", "Newark" },
                { "18", "DUNS14", "intel.com", "DUNS56", 13232323323L, 50900, "Y", ">10B", ">10,000", "Union City" },
                // with NULL DU and domain
                { "15", null, null, "DUNS87", 1922222223L, 11110, "Y", "1-5B", ">10,000", "San Carlos" },
                // with NULL domain
                { "16", "DUNS79", null, "DUNS77", 19788888873L, 22222, "Y", ">10B", ">10,000", "Sausilato" }
        };
    ...
    private Object[][] expectedDataValues = {
            ...
            { 6, 77773, "intuit.com", "DUNS23", 3555555880L, "N", "DUNS99", "Gilroy", "N", ">10,000", "1-5B" },
            { 7, 10893, "datos.com", "DUNS13", 8820000000L, "Y", "DUNS90", "Palo Alto", "N", ">10,000", "5-10B" },
            { 2, 90872, "merc.com", "DUNS14", 18160000000L, "Y", "DUNS14", "Santa Clara", "N", ">10,000", ">10B" },
            { 15, 11110, null, "DUNS87", 1922222223L, "Y", null, "San Carlos", "N", ">10,000", "1-5B" },
            ...
            { 12, 8000, "microsoft.com", "DUNS11", 88887203333L, "Y", "DUNS11", "Foster City", "N", "5001-10,000",
                    ">10B" },
            { 21, 2600, "sbi.com", "DUNS63", 1000000L, "Y", "DUNS63", "Tahoe", "Y", "2501-5000", "0-1M" },
            ...
            { 11, 13049, "dell.com", "DUNS34", 59444444470L, "Y", null, "Fremont", "N", ">10,000", ">10B" },
            { 9, 45763, "dsv.com", "DUNS88", 5420000000L, "Y", null, "Foster City", "N", ">10,000", "5-10B" },
            { 19, 45763, "baidu.com", "DUNS88", 5420000000L, "Y", null, "Foster City", "Y", ">10,000", "5-10B" },
            { 8, 89898, "teradata.com", "DUNS90", 8820000000L, "Y", "DUNS90", "Los Gatos", "N", ">10,000", "5-10B" },
            { 20, 19843, "csx.com", "DUNS26", 35970088880L, "Y", "DUNS99", "Newark", "N", ">10,000", ">10B" },
            ...
            { 16, 82938, "lattice-engines.com", "DUNS77", 19788888873L, "Y", "DUNS79", "Sausilato", "Y", ">10,000",
                    ">10B" },
            { 7, 10893, "netflix.com", "DUNS13", 8820000000L, "Y", "DUNS90", "Palo Alto", "Y", ">10,000", "5-10B" },

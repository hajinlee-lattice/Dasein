    ...
    void verifyResultAvroRecords(Iterator<GenericRecord> records) {
        ...
        Object[][] expectedData = {
                ...
                { 1L, 53L, 1057L, 1069L, 1080L, 1081L, 122L, "618@122|616@122|619@122|622@122|614@122|",
                        "314@16|315@16|316@16|317@16|318@16|319@1", null, null, 1L },
                ...
                { 2L, 53L, 1057L, 1069L, 1080L, 1081L, 88L, "618@88|616@88|619@88|622@88|614@88|621@8",
                        "324@14|325@14|326@14|327@14|328@9|329@14", null, null, 10L },
        ...
        while (records.hasNext()) {
            ...
            for (Field field : record.getSchema().getFields()) {
                if (!field.name().equals("EncodedCube") && field.name().equals("PID")) {

...
public class SoftDeleteTxfmrWithDifferentJoinColumnTestNG extends PipelineTransformationTestNGBase {

    private static final Logger log = LoggerFactory.getLogger(SoftDeleteTxfmrWithDifferentJoinColumnTestNG.class);
    ...
    private final String SourceJoinId = "EntityId";
    ...
    protected PipelineTransformationConfiguration createTransformationConfiguration() {
        ...
        jobConfig.setSourceIdColumn(SourceJoinId);
    ...
    protected void verifyResultAvroRecords(Iterator<GenericRecord> records) {
        ...
        while (records.hasNext()) {
            ...
            Assert.assertNotEquals(record.get(SourceJoinId).toString(), "Account1");
            Assert.assertNotEquals(record.get(SourceJoinId).toString(), "Account2");
            Assert.assertNotEquals(record.get(SourceJoinId).toString(), "Account5");
            Assert.assertNotEquals(record.get(SourceJoinId).toString(), "Account100");
    ...
    private void prepareBaseSrc() {
        ...
        columns.add(Pair.of(SourceJoinId, String.class));

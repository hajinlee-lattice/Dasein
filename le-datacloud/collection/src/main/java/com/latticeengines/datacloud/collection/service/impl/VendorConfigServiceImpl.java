...
public class VendorConfigServiceImpl implements VendorConfigService {
    ...
    private List<VendorConfig> fetchVendorConfigs() {
         ...
         * alexaConfig.setDomainCheckField("");//fixme: modify when alexa is
         * ready alexaConfig.setCollectingFreq(monthInSecs * 3);
         ...
         * competeConfig.setDomainField("");//fixme: modify when compete is
         * ready competeConfig.setDomainCheckField("");//fixme: modify compete
         * alexa is ready competeConfig.setCollectingFreq(monthInSecs * 1);
         ...
         * featureConfig.setDomainField("");//fixme: modify when feature is
         * ready featureConfig.setDomainCheckField("");//fixme: modify when
         * feature is ready featureConfig.setCollectingFreq(monthInSecs * 6);
         ...
         * hpaNewConfig.setDomainCheckField("");//fixme: modify when hpa_new is
         * ready hpaNewConfig.setCollectingFreq(monthInSecs * 6);
         ...
         * orbitV2Config.setDomainCheckField("");//fixme: modify when orbit is
         * ready orbitV2Config.setCollectingFreq(monthInSecs * 3);
         ...
         * semrushConfig.setDomainField("");//fixme: modify when semrush is
         * ready semrushConfig.setDomainCheckField("");//fixme: modify when
         * semrush is ready semrushConfig.setCollectingFreq(monthInSecs * 1);

...
@Component("accountMasterSeedSecondaryDomain")
public class AccountMasterSeedSecondaryDomain implements DerivedSource {
    ...
    public String getSourceName() {
        return "AccountMasterSeedSecondaryDomain";
    }

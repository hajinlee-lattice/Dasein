...
@Component
public class RealTimeMatchExecutorTestNG extends DataCloudMatchFunctionalTestNGBase {

    @Autowired
    @Qualifier("realTimeMatchExecutor")
    private MatchExecutor realTimeMatchExecutor;
    ...
    public void testDistributeResults() {
        List<InternalOutputRecord> recordList = ((RealTimeMatchExecutor) realTimeMatchExecutor).distributeResults(prepareRecords(),
                prepareResultsMap());
    ...
    public void testMergeResults() {
        ...
        matchContext = ((RealTimeMatchExecutor) realTimeMatchExecutor).mergeResults(matchContext);

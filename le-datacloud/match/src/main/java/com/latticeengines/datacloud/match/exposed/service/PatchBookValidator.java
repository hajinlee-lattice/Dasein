...
public interface PatchBookValidator {
    ...
    static final String ATTRI_PATCH_DOM_BASED_SRC_ERR = "Provided patch attribute is not from Domain source : ";

    static final String ATTRI_PATCH_DUNS_BASED_SRC_ERR = "Provided patch attribute is not from Duns source : ";

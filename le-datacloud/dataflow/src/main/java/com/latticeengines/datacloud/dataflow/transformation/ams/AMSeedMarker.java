...
public class AMSeedMarker extends AccountMasterBase<AMSeedMarkerConfig> {
    ...
    private Node markIsPrimaryDomain(Node node, Node alexa) {
        ...
        String domainOnlyEntryLog = OperationLogUtils.buildLog(DataCloudConstants.TRANSFORMER_AMSEED_MARKER, OperationCode.IS_PRIMARY_DOMAIN, OperationMessage.ONLY_ONE_DOMAIN);

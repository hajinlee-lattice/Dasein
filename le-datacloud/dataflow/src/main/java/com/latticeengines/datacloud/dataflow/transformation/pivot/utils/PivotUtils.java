package com.latticeengines.datacloud.dataflow.transformation.pivot.utils;
...
public class PivotUtils {
    ...
    private static PivotStrategy constructPivotStrategy(SourceColumn column, String rowIdField) {
        PivotType pivotType;
    ...
    @VisibleForTesting
    static Map<ImmutableList<String>, PivotStrategy> getPivotStrategyMap(List<SourceColumn> columns, String rowIdField) {
        Map<SourceColumn, PivotStrategy> strategyMap = new HashMap<>();
        for (SourceColumn column : columns) {
            PivotStrategy pivotStrategy = constructPivotStrategy(column, rowIdField);
    ...
    private static Map<ImmutableList<String>, List<Aggregation>> getAggregationMap(List<SourceColumn> columns) {
    ...
    private static Node rewriteBoolean(Node pipe, List<SourceColumn> columns) {
    ...
    private static boolean hasRowCount(PivotStrategyImpl impl, String rowIdField) {
        return rowIdField.equals(impl.valueColumn);
    }

    private static List<Node> pivotPipes(List<SourceColumn> columns,
                                         Map<String, Node> sourceMap,
                                         String[] joinFields,
                                         String rowIdField) {
        Map<ImmutableList<String>, PivotStrategy> pivotStrategyMap = getPivotStrategyMap(columns, rowIdField);
        ...
        for (Map.Entry<ImmutableList<String>, PivotStrategy> entry : pivotStrategyMap.entrySet()) {
            ...
            if (hasRowCount((PivotStrategyImpl)entry.getValue(), rowIdField)) {
    ...
    private static List<Node> aggregatedPipes(List<SourceColumn> columns, Map<String, Node> sourceMap, String[] joinFields) {
    ...
    private static Node joinPipe(String[] joinFields, Node[] pipes) {
    ...
    private static Node rewriteIsNull(Node join, List<SourceColumn> columns) {
    ...
    private static Node joinedAggregatedPipes(List<SourceColumn> columns,
                                              String[] joinFields,
                                              Map<String, Node> sourceMap) {
        ...
        join = rewriteIsNull(join, columns);
        return join;
    }

    private static Node joinedPivotedPipes(List<SourceColumn> columns,
                                           String[] joinFields,
                                           Map<String, Node> sourceMap,
                                           String rowIdField) {
        List<Node> pivotedPipes = pivotPipes(columns, sourceMap, joinFields, rowIdField);
    ...
    public static Node finalRetain(Node node, List<SourceColumn> columns) {
    ...
    public static Node joinedConfigurablePipes(List<SourceColumn> columns,
                                               String[] joinFields,
                                               Map<String, Node> sourceMap,
                                               String rowIdField) {
        Node pivot = joinedPivotedPipes(columns, joinFields, sourceMap, rowIdField);
        Node agg = joinedAggregatedPipes(columns, joinFields, sourceMap);

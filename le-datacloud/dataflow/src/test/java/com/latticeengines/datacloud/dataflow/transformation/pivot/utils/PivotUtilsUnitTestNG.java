...
public class PivotUtilsUnitTestNG {
    private String rowIdField = "RowId" + UUID.randomUUID().toString().replace("-", "");

    @Test(groups = "unit")
    public void testSimplePivotGroups() {
        Object[][] data = new Object[][] {
                { "Column1", "INT", "Base1", "GroupBy1,GroupBy2", SourceColumn.Calculation.PIVOT_MAX,
                        "{\"PivotKeyColumn\":\"Key\",\"PivotValueColumn\":\"Value\",\"TargetPivotKeys\":\"Key1\"}" },
                { "Column2", "INT", "Base1", "GroupBy1,GroupBy2", SourceColumn.Calculation.PIVOT_MAX,
                        "{\"PivotKeyColumn\":\"Key\",\"PivotValueColumn\":\"Value\",\"TargetPivotKeys\":\"Key2\"}" },
                { "Column3", "INT", "Base1", "GroupBy1,GroupBy2", SourceColumn.Calculation.PIVOT_MAX,
                        "{\"PivotKeyColumn\":\"Key\",\"PivotValueColumn\":\"Value\",\"TargetPivotKeys\":\"Key3\"}" }, };
        List<SourceColumn> columns = parseData(data);
        Map<ImmutableList<String>, PivotStrategy> pivotStrategyMap = PivotUtils.getPivotStrategyMap(columns, rowIdField);
    ...
    public void testDifferentColumnTypeSamePivot() {
        Object[][] data = new Object[][] {
                ...
                { "Column2", "INT", "Base1", "GroupBy1,GroupBy2", SourceColumn.Calculation.PIVOT_MAX,
                        "{\"PivotKeyColumn\":\"Key\",\"PivotValueColumn\":\"Value\",\"TargetPivotKeys\":\"Key2\"}" },
                { "Column3", "BIGINT", "Base1", "GroupBy1,GroupBy2", SourceColumn.Calculation.PIVOT_MAX,
                        "{\"PivotKeyColumn\":\"Key\",\"PivotValueColumn\":\"Value\",\"TargetPivotKeys\":\"Key3\"}" }, };
        List<SourceColumn> columns = parseData(data);
        Map<ImmutableList<String>, PivotStrategy> pivotStrategyMap = PivotUtils.getPivotStrategyMap(columns, rowIdField);
        Assert.assertEquals(pivotStrategyMap.size(), 1);
    ...
    public void testDifferentPivotTypeSamePivot() {
        Object[][] data = new Object[][] {
                ...
                { "Column2", "INT", "Base1", "GroupBy1,GroupBy2", SourceColumn.Calculation.PIVOT_MAX,
                        "{\"PivotKeyColumn\":\"Key\",\"PivotValueColumn\":\"Value\",\"TargetPivotKeys\":\"Key2\"}" },
                { "Column3", "BIGINT", "Base1", "GroupBy1,GroupBy2", SourceColumn.Calculation.PIVOT_MIN,
                        "{\"PivotKeyColumn\":\"Key\",\"PivotValueColumn\":\"Value\",\"TargetPivotKeys\":\"Key3\"}" }, };
        List<SourceColumn> columns = parseData(data);
        Map<ImmutableList<String>, PivotStrategy> pivotStrategyMap = PivotUtils.getPivotStrategyMap(columns, rowIdField);
        Assert.assertEquals(pivotStrategyMap.size(), 1);
    ...
    public void testDifferentGroupByDifferentPivot() {
        Object[][] data = new Object[][] {
                ...
                { "Column3", "INT", "Base1", "GroupBy1", SourceColumn.Calculation.PIVOT_MAX,
                        "{\"PivotKeyColumn\":\"Key\",\"PivotValueColumn\":\"Value\",\"TargetPivotKeys\":\"Key3\"}" }, };
        List<SourceColumn> columns = parseData(data);
        Map<ImmutableList<String>, PivotStrategy> pivotStrategyMap = PivotUtils.getPivotStrategyMap(columns, rowIdField);
    ...
    public void testDifferentBaseDifferentPivot() {
        Object[][] data = new Object[][] {
                ...
                { "Column2", "INT", "Base1", "GroupBy1,GroupBy2", SourceColumn.Calculation.PIVOT_MAX,
                        "{\"PivotKeyColumn\":\"Key\",\"PivotValueColumn\":\"Value\",\"TargetPivotKeys\":\"Key2\"}" },
                { "Column3", "INT", "Base2", "GroupBy1,GroupBy2", SourceColumn.Calculation.PIVOT_MAX,
                        "{\"PivotKeyColumn\":\"Key\",\"PivotValueColumn\":\"Value\",\"TargetPivotKeys\":\"Key3\"}" }, };
        List<SourceColumn> columns = parseData(data);
        Map<ImmutableList<String>, PivotStrategy> pivotStrategyMap = PivotUtils.getPivotStrategyMap(columns, rowIdField);
        Assert.assertEquals(pivotStrategyMap.size(), 2);
    ...
    private List<SourceColumn> parseData(Object[][] data) {
        ...
        for (Object[] record : data) {
            ...
            column.setCalculation((SourceColumn.Calculation) record[4]);

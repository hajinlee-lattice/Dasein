...
//                : null;
    ...
    static Map<String, BitCodeBook> getBitCodeBook() {
        BitCodeBook bitCodeBook = new BitCodeBook();
        Map<String, Integer> bitPosMap = ImmutableMap.of( //
                ATTR_ENCODED_1, 3, //
                ATTR_ENCODED_2, 1026, //
                ATTR_ENCODED_3, 16
        );
        bitCodeBook.setBitsPosMap(bitPosMap);
        bitCodeBook.setDecodeStrategy(BitCodeBook.DecodeStrategy.BOOLEAN_YESNO);
        bitCodeBook.setBitUnit(1);
        return ImmutableMap.of(ATTR_ENCODED, bitCodeBook);
    }

    static Map<String, String> getBitCodeLookup() {
        return ImmutableMap.of(
                ATTR_ENCODED_1, ATTR_ENCODED, ATTR_ENCODED_2, ATTR_ENCODED, ATTR_ENCODED_3, ATTR_ENCODED
        );
    }

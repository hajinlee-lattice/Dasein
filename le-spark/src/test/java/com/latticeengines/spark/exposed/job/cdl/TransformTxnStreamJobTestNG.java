...
public class TransformTxnStreamJobTestNG extends SparkJobFunctionalTestNGBase {
    ...
    private static final List<String> PERIOD_TXN_FIELDS = Arrays.asList(accountId, periodId, periodName, productId,
            productType, totalAmount, totalCost, totalQuantity, txnCount, txnType, compositeKey);
    ...
    private void testAggregatedTxn() {
    ...
    private void testConsolidatedPeriodTxn() {
        List<String> inputs = Arrays.asList(setupAnalyticWeekPeriod(), setupSpendingWeekPeriod());
        TransformTxnStreamConfig config = new TransformTxnStreamConfig();
    ...
    @Test(groups = "functional")
    private void testAggregatedPeriodTxn() {
        List<String> inputs = Arrays.asList(setupAnalyticWeekPeriod(), setupSpendingWeekPeriod(),
                setupAnalyticMonthPeriod(), setupSpendingMonthPeriod());
        TransformTxnStreamConfig config = new TransformTxnStreamConfig();
        config.compositeSrc = Arrays.asList(accountId, productId, productType, txnType, periodId, periodName);
        config.renameMapping = constructPeriodRename();
    ...
    private String setupSpendingDaily() {
        ...
        Object[][] data = new Object[][] { //
                { "a1", "c1", "p1", "Purchase", "Spending", DAY_1, DAY_1_PERIOD, 2, 10.0, 1, 0.1, 0L, 0L }, //
                { "a1", "c1", "p1", "Purchase", "Spending", DAY_2, DAY_2_PERIOD, 1, 70.0, 7, 0.7, 0L, 0L }, //
                { "a1", "c1", "p2", "Purchase", "Spending", DAY_1, DAY_1_PERIOD, 1, 60.0, 6, 0.6, 0L, 0L } //
        };
    ...
    private String setupAnalyticDaily() {
        ...
        Object[][] data = new Object[][] { //
                { "a1", "c1", "p1", "Purchase", "Analytic", DAY_1, DAY_1_PERIOD, 2, 10.0, 1, 0.1, 0L, 0L }, //
                { "a1", "c1", "p1", "Purchase", "Analytic", DAY_2, DAY_2_PERIOD, 1, 70.0, 7, 0.7, 0L, 0L }, //
                { "a1", "c1", "p2", "Purchase", "Analytic", DAY_1, DAY_1_PERIOD, 1, 60.0, 6, 0.6, 0L, 0L } //
        };
        return uploadHdfsDataUnit(data, fields);
    }

    private String setupAnalyticWeekPeriod() {
        List<Pair<String, Class<?>>> fields = Arrays.asList( //
                Pair.of(accountId, String.class), //
                Pair.of(contactId, String.class), //
                Pair.of(productId, String.class), //
        ...
        Object[][] data = new Object[][] { //
                { "a1", "c1", "p1", "Purchase", "Analytic", 1031, 10, 1.21, 11, 0.01, null, 0L } };
        return uploadHdfsDataUnit(data, fields);
    }

    private String setupSpendingWeekPeriod() {
        List<Pair<String, Class<?>>> fields = Arrays.asList( //
                Pair.of(accountId, String.class), //
                Pair.of(contactId, String.class), //
                Pair.of(productId, String.class), //
        ...
        Object[][] data = new Object[][] { //
                { "a1", "c1", "p1", "Purchase", "Spending", 1031, 15, 16.0, 4, 4.0, null, 0L } };
        return uploadHdfsDataUnit(data, fields);
    }
    ...
    private String setupAnalyticMonthPeriod() {
        ...
        Object[][] data = new Object[][] { //
                { "a1", "c1", "p1", "Purchase", "Analytic", 999, 10, 1.21, 11, 0.01, null, 0L } };
        return uploadHdfsDataUnit(data, fields);
    }

    private String setupSpendingMonthPeriod() {
        List<Pair<String, Class<?>>> fields = Arrays.asList( //
                Pair.of(accountId, String.class), //
                Pair.of(contactId, String.class), //
                Pair.of(productId, String.class), //
        ...
        Object[][] data = new Object[][] { //
                { "a1", "c1", "p1", "Purchase", "Spending", 888, 15, 16.0, 4, 4.0, null, 0L } };
        return uploadHdfsDataUnit(data, fields);
    }
    ...
    private Boolean verifyOutputPeriodFields(HdfsDataUnit output) {
        Iterator<GenericRecord> iterator = verifyAndReadTarget(output);
        Set<String> outputFields = new HashSet<>(PERIOD_TXN_FIELDS);
        for (GenericRecord record : (Iterable<GenericRecord>) () -> iterator) {
            Assert.assertEquals(
                    record.getSchema().getFields().stream().map(Schema.Field::name).collect(Collectors.toSet()),
                    outputFields);

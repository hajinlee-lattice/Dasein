...
public class LivyServerManager {
    ...
    private String getNextLivyServerUrl(String emrClusterName) {
        ...
        // no livy server available, might need to trigger the livy server provision process
    ...
    private synchronized boolean  populateServerQueue(String emrClusterName) {
        ...
        // first check if the key even exists in consul KV store; if not, return right away

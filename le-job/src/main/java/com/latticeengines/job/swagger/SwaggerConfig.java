package com.latticeengines.job.swagger;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2) //
                .select() //
                .apis(SwaggerUtils.getApiSelector("com.latticeengines.job.controller.*")) //
    ...
    private springfox.documentation.service.ApiInfo apiInfo() {
        return new ApiInfoBuilder() //
                .title("Lattice Engines Job Server") //
                .description("This is the REST API for job services.") //

...
public class PythonContainer implements YarnContainer {
    ...
    public void run() {
        ...
        log.info("Training file " + trainingFile.getAbsolutePath()
                + " exists = " + trainingFile.exists());
        File testFile = new File(testFileName);
        log.info("Test file " + testFile.getAbsolutePath() + " exists = "
                + testFile.exists());
        File pythonFile = new File(pythonScript);
        log.info("Python script " + pythonFile.getAbsolutePath() + " exists = "
                + pythonFile.exists());
    }
    ...
    public void setParameters(Properties parameters) {
        ...
        trainingFileName = parameters
                .getProperty(PythonContainerProperty.TRAINING.name());
        testFileName = parameters.getProperty(PythonContainerProperty.TEST
                .name());
        pythonScript = parameters
                .getProperty(PythonContainerProperty.PYTHONSCRIPT.name());

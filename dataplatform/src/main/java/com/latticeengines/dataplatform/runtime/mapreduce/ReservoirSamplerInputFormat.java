...
public class ReservoirSamplerInputFormat<K extends Writable, V extends Writable>
    ...
    public static final String USE_SAMPLES_NUMBER_PER_INPUT_SPLIT = "reservoir.samples.useperinputsplit";
    public static final String MAXRECORDS_READ = "reservoir.samples.maxrecordsread";

    public static final int DEFAULT_NUM_SAMPLES = 1000;
    public static final boolean DEFAULT_USE_SAMPLES_PER_INPUT_SPLIT = false;
    ...
    public static void setNumSamples(Job job, int numSamples) {
        job.getConfiguration().setInt(SAMPLES_NUMBER, numSamples);
    }

    public static void setMaxRecordsToRead(Job job, int maxRecords) {

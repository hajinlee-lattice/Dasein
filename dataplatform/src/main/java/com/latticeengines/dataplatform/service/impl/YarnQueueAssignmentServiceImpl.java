...
public class YarnQueueAssignmentServiceImpl implements YarnQueueAssignmentService {
	...
	@Override
	public String assignToQueue(String assignmentToken, AssignmentPolicy policy) throws UnsupportedEncodingException, 
		...
		{
			throw new NotImplementedException("AssignmentPolicy policy " + policy.toString() + " not implemented");
		}

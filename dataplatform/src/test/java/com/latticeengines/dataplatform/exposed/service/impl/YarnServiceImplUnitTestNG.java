...
public class YarnServiceImplUnitTestNG {
    ...
    public void getPreemptedApps() {
        ...
        when(app1.getQueue()).thenReturn("Priority0.A");
        when(app2.getQueue()).thenReturn("Priority1.A");
        when(app3.getQueue()).thenReturn("Priority0.B");
        when(app4.getQueue()).thenReturn("Priority1.B");

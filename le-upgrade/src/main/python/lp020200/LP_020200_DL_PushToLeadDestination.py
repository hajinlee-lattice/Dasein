...
class LP_020200_DL_PushToLeadDestination(StepBase):
  ...
  def apply(self, appseq):
    ...
    # Add key into the diagnostic load groups
    diag_ptld_xml = ''
    diag_ptld_xml = '''
    <group name="Diagnostic_PushToDestination" alias="Diagnostic_PushToDestination" type="1" scheduleType="0"
    allowUserChangeScheduleType="False" visibleForEndUser="True" threshold="10000" launchExpiredDays="7"
    createdBy="richard.liu@lattice-engines.com" path="Diagnostic" autoGenerated="False" validationValidMinutes="120"
    autoClearOnFailure="True" mergeRulesSaved="True" ng="False">
      <schemas />
      <visiDBConfigurationWithMacros />
      <targetQueries>
        <targetQuery w="Workspace" t="2" name="Q_Diagnostic_MissingDownloadedLeads"
        alias="Q_Diagnostic_MissingDownloadedLeads" isc="True" threshold="10000" fsTableName="UnscoredLeads"
        sourceType="1" jobType="20" ignoreOptionsValue="0" exportToDestDirectly="True" exportRule="4" fileExt="bcp"
        rowTerminator="\\0\\r" columnTerminator="\\0" edts="False" destType="SQL"
        destDataProvider="SQL_LeadValidation_DataProvider" cto="0">
          <schemas />
          <specs />
          <fsColumnMappings />
          <excludeColumns />
        ...
        alias="Q_Diagnostic_DownloadedUnscoredLeads" isc="True" threshold="10000" fsTableName="UnscoredLeads"
        sourceType="1" jobType="20" ignoreOptionsValue="0" exportToDestDirectly="True" exportRule="4" fileExt="bcp"
        rowTerminator="\\0\\r" columnTerminator="\\0" edts="False" destType="SQL"
        destDataProvider="SQL_LeadValidation_DataProvider" cto="0">
          <schemas />
    ...
    lgm.setLoadGroup(diag_ptld_xml)

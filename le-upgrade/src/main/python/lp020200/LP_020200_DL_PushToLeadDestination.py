...
class LP_020200_DL_PushToLeadDestination( StepBase ):
  ...
  def getApplicability( self, appseq ):
    ...
    if lgm.hasLoadGroup( 'PushToLeadDestination_Validation' ) and lgm.hasLoadGroup( 'PushToLeadDestination_TimeStamp' ) and lgm.hasLoadGroup( 'PushToLeadDestination_Validation' ) :
  ...
  def apply( self, appseq ):
    ...
    lgm.createLoadGroup( 'PushToLeadDestination_Validation', 'OperationalProcess\Standard', 'PushToLeadDestination_Validation', True, False )
    step1xml = ''
    if type == 'MKTO':
      step1xml = '''
    ...
    lgm.createLoadGroup( 'PushToLeadDestination_TimeStamp', 'OperationalProcess\Standard', 'PushToLeadDestination_TimeStamp', True, False )
    ...
    lgm.createLoadGroup( 'PushLeadsLastScoredToDestination', 'OperationalProcess\Standard', 'PushLeadsLastScoredToDestination', True, False )

    step3xml = ''
    if type == 'MKTO':
      step3xml = '''<extractQueries>

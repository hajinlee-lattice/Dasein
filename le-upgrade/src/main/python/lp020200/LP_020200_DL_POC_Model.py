...
class LP_020200_DL_POC_Model( StepBase ):
  ...
  def getApplicability( self, appseq ):
    ...
    if lgm.hasLoadGroup( 'Download_BasicModelingSet' ) and lgm.hasLoadGroup( 'Initialize' ) and lgm.hasLoadGroup( 'Model' ) and lgm.hasLoadGroup( 'Score_ConfiguredDateRange' ) and lgm.hasLoadGroup( 'Upload_LatestScoredLeadsToCustomer' ) :
  ...
  def apply( self, appseq ):
    ...
    <group name="LoadCRMDataForModeling" alias="LoadCRMDataForModeling" w="Workspace" type="1" scheduleType="0" allowUserChangeScheduleType="False" visibleForEndUser="True" threshold="10000" launchExpiredDays="7" createdBy="tiyu@lattice-engines.com" path="ModelBuild\Standard" autoGenerated="False" validationValidMinutes="120" autoClearOnFailure="False" mergeRulesSaved="True" ng="False">
      ...
      <rdss>
        <rds n="SFDC_User" w="Workspace" sn="SFDC_User" cn="SFDC_DataProvider" u="False" ss="" tn="User" nmo="1" f="@datediff(now, month(12))" ad="True" em="False" td="False" ic="" dd="" l="1000" tw="False" sr="50000" htw="24" mtw="60" emt="False" acd="True" mgf="True" eo="1" emd="False" eo_sftp="1" />
        <rds n="SFDC_Contact" w="Workspace" sn="SFDC_Contact" cn="SFDC_DataProvider" u="False" ss="" tn="Contact" nmo="1" f="@datediff(now, month(12))" ad="True" em="False" td="False" ic="" dd="" l="1000" tw="False" sr="50000" htw="24" mtw="60" emt="False" acd="True" mgf="True" eo="1" emd="False" eo_sftp="1">
          <mcs>
            <mc cn="Id" />
          </mcs>
        </rds>
        <rds n="SFDC_Lead" w="Workspace" sn="SFDC_Lead" cn="SFDC_DataProvider" u="False" ss="" tn="Lead" nmo="1" f="@datediff(now, month(12))" ad="True" em="False" td="False" ic="" dd="" l="1000" tw="False" sr="50000" htw="24" mtw="60" emt="False" acd="True" mgf="True" eo="1" emd="False" eo_sftp="1" />
        ...
        <rds n="SFDC_OpportunityContactRole" w="Workspace" sn="SFDC_OpportunityContactRole" cn="SFDC_DataProvider" u="False" ss="" tn="OpportunityContactRole" nmo="1" f="@datediff(now, month(12))" ad="True" em="False" td="False" ic="" dd="" l="1000" tw="False" sr="50000" htw="24" mtw="60" emt="False" acd="True" mgf="True" eo="1" emd="False" eo_sftp="1" />
      </rdss>
      <validationExtracts />
      <ces />
      <extractQueries>
      ...
      lgm.createLoadGroup( 'LoadMAPDataForModeling_ActivityRecord_NewLead', 'ModelBuild\Standard', 'LoadMAPDataForModeling_ActivityRecord_NewLead', True, False )
      step3xml = ''
      step3xml = '''
    ...
    # POC MKTO 3: Seperate 8 activity types for LoadMAPDataForModeling_ActivityRecord_OtherThanNewLead
      lgm.createLoadGroup( 'LoadMAPDataForModeling_ActivityRecord_OtherThanNewLead', 'ModelBuild\Standard', 'LoadMAPDataForModeling_ActivityRecord_OtherThanNewLead', True, False )
      step4xml = ''
      step4xml = '''
      ...
      lgm.createLoadGroup( 'LoadMAPDataForModeling_ActivityRecord_2Days', 'Provisioning', 'LoadMAPDataForModeling_ActivityRecord_2Days', True, False )
      step6xml = ''
      step6xml = '''

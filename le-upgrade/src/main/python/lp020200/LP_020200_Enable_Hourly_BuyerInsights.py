...
class LP_020200_Enable_Hourly_BuyerInsights(StepBase):
  name = 'LP_020200_Enable_Hourly_BuyerInsights'
  description = 'Enable the hourly buyer insights feature'
  version = '$Rev: 71901 $'

  def __init__(self, forceApply=False):
    super(LP_020200_Enable_Hourly_BuyerInsights, self).__init__(forceApply)

...
class LP_020100_Diagnostic(StepBase):
  ...
  def apply(self, appseq):
      ...
      SpecLatticeNamedElement(
        SpecLatticeFunction(
          LatticeFunctionExpressionConstantScalar(
            "__CUSTOMER_ID__",
            DataTypeVarChar(__CUSTOMER_ID_LENGTH__)
          ),
          DataTypeUnknown,
    ...
    tenantNameSpec = tenantNameSpec.replace('__CUSTOMER_ID__', customerId)
    tenantNameSpec = tenantNameSpec.replace('__CUSTOMER_ID_LENGTH__',str(len(customerId)))
    ...
    if type == 'MKTO':
      ...
      specs += 'SpecLatticeNamedElement(SpecLatticeSourceTable(SpecLatticeSourceTableColumnSet((' \
               ...
               '"__SCORE_DATE_FIELD__"))), DataTypeDateTime, SpecFieldTypeMetric(' \
               'FunctionAggregationOperator("Max")), SpecColumnContentContainerElementName(ContainerElementName(' \
               '"__SCORE_DATE_FIELD__")), SpecEndpointTypeNone, SpecDefaultValueNull, ' \
               'SpecKeyAggregation(SpecColumnAggregationRuleFunction("Max")), SpecEquivalenceAggregation(' \
               'SpecColumnAggregationRuleFunction("Max"))), SpecLatticeSourceTableColumn(LatticeFunctionIdentifier(' \
               'ContainerElementNameTableQualifiedName(LatticeSourceTableIdentifier(ContainerElementName(' \
               '"MKTO_LeadRecord_Validation")), ContainerElementName("__SCORE_FIELD__"))), DataTypeInt, ' \
               'SpecFieldTypeMetric(FunctionAggregationOperator("Sum")), SpecColumnContentContainerElementName(' \
               'ContainerElementName("__SCORE_FIELD__")), SpecEndpointTypeNone, SpecDefaultValueNull, ' \
               ...
               'DataTypeInt), SpecColumnBinding(ContainerElementName("__SCORE_DATE_FIELD__"), ' \
               'DataTypeDateTime), SpecColumnBinding(ContainerElementName("__SCORE_FIELD__"), ' \
               ...
               'SpecColumnBinding(ContainerElementName("__SCORE_DATE_FIELD__"), ' \
               '1000000000000000000000000000094), SpecColumnBinding(ContainerElementName(' \
               '"__SCORE_FIELD__"), 1000000000000000000000000000099))), SpecImportDate("2015-11-04 ' \
               ...
               'ContainerElementName("__SCORE_FIELD__"))), DataTypeUnknown, SpecFunctionTypeMetric, ' \
               ...
               'ContainerElementNameTableQualifiedName(LatticeSourceTableIdentifier(ContainerElementName(' \
               '"MKTO_LeadRecord_Validation")), ContainerElementName("__SCORE_DATE_FIELD__"))), ' \
      ...
      specs += 'SpecLatticeNamedElement(SpecLatticeSourceTable(SpecLatticeSourceTableColumnSet((' \
               ...
               'ContainerElementNameTableQualifiedName(LatticeSourceTableIdentifier(' \
               'ContainerElementName("ELQ_Contact_Validation")), ContainerElementName(' \
               '"__SCORE_FIELD__"))), DataTypeDouble, SpecFieldTypeMetric(' \
               ...
               '"__SCORE_DATE_FIELD__"))), DataTypeDateTime, SpecFieldTypeMetric(' \
               'FunctionAggregationOperator("Max")), SpecColumnContentContainerElementName(' \
               'ContainerElementName("__SCORE_DATE_FIELD__")), SpecEndpointTypeNone, ' \
               ...
               '"__SCORE_FIELD__"), DataTypeDouble), SpecColumnBinding(' \
               ...
               '"__SCORE_FIELD__"), 1000000000000000000000000000021), SpecColumnBinding(' \
               ...
               'ContainerElementName("__SCORE_FIELD__"))), DataTypeUnknown, ' \
               ...
               'ContainerElementNameTableQualifiedName(LatticeSourceTableIdentifier(' \
               'ContainerElementName("ELQ_Contact_Validation")), ContainerElementName(' \
               '"__SCORE_DATE_FIELD__"))), DataTypeUnknown, SpecFunctionTypeMetric, ' \
               'SpecFunctionSourceTypeCalculation, SpecDefaultValueNull, SpecDescription("")), ' \
      ...
      specs += 'SpecLatticeNamedElement(SpecLatticeSourceTable(SpecLatticeSourceTableColumnSet((' \
               ...
               'SpecEquivalenceAggregation(SpecColumnAggregationRuleFunction("Max"))),SpecLatticeSourceTableColumn(' \
               'LatticeFunctionIdentifier(ContainerElementNameTableQualifiedName(LatticeSourceTableIdentifier(' \
               'ContainerElementName("SFDC_Contact_Validation")),ContainerElementName("__SCORE_FIELD__"))),' \
               ...
               'SpecColumnAggregationRuleFunction("Max"))),SpecLatticeSourceTableColumn(LatticeFunctionIdentifier(' \
               'ContainerElementNameTableQualifiedName(LatticeSourceTableIdentifier(ContainerElementName(' \
               '"SFDC_Lead_Validation")),ContainerElementName("__SCORE_FIELD__"))),DataTypeInt,' \
               'SpecFieldTypeMetric(FunctionAggregationOperator("Sum")),SpecColumnContentContainerElementName(' \
               'ContainerElementName("__SCORE_FIELD__")),SpecEndpointTypeNone,SpecDefaultValueNull,' \
               'SpecKeyAggregation(SpecColumnAggregationRuleFunction("Sum")),SpecEquivalenceAggregation(' \
               'SpecColumnAggregationRuleFunction("Sum"))),SpecLatticeSourceTableColumn(LatticeFunctionIdentifier(' \
               'ContainerElementNameTableQualifiedName(LatticeSourceTableIdentifier(ContainerElementName(' \
               '"SFDC_Lead_Validation")),ContainerElementName("__SCORE_DATE_FIELD__"))),' \
               'DataTypeDateTime,SpecFieldTypeMetric(FunctionAggregationOperator("Max")),' \
               'SpecColumnContentContainerElementName(ContainerElementName("__SCORE_DATE_FIELD__")),' \
               ...
               '"__SCORE_DATE_FIELD__"),DataTypeDateTime),SpecColumnBinding(ContainerElementName(' \
               '"__SCORE_FIELD__"),DataTypeInt))),SpecSourceFilterNone),ContainerElementName(' \
               ...
               'ContainerElementName("__SCORE_DATE_FIELD__"),1000000000000000000000000000025),' \
               'SpecColumnBinding(ContainerElementName("__SCORE_FIELD__"),' \
               ...
               '"__SCORE_DATE_FIELD__"),1000000000000000000000000000059),SpecColumnBinding(' \
               'ContainerElementName("__SCORE_FIELD__"),1000000000000000000000000000064))),SpecImportDate(' \
               ...
               'LatticeSourceTableIdentifier(ContainerElementName("SFDC_Contact_Validation")),ContainerElementName(' \
               '"__SCORE_FIELD__"))),LatticeFunctionIdentifier(ContainerElementNameTableQualifiedName(' \
               'LatticeSourceTableIdentifier(ContainerElementName("SFDC_Lead_Validation")),ContainerElementName(' \
               '"__SCORE_FIELD__")))),LatticeAddressSetPi(LatticeAddressExpressionAtomic(' \
               ...
               '"IsNull"),LatticeFunctionIdentifier(ContainerElementNameTableQualifiedName(' \
               'LatticeSourceTableIdentifier(ContainerElementName("SFDC_Contact_Validation")),ContainerElementName(' \
               '"__SCORE_DATE_FIELD__"))),LatticeFunctionIdentifier(' \
               'ContainerElementNameTableQualifiedName(LatticeSourceTableIdentifier(ContainerElementName(' \
               '"SFDC_Lead_Validation")),ContainerElementName("__SCORE_DATE_FIELD__")))),' \
               'LatticeAddressSetPi(LatticeAddressExpressionAtomic(LatticeAddressAtomicIdentifier(' \

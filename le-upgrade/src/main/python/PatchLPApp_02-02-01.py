...
sequence = []
sequence.append( appsequence.LPCheckVersion('2.2.0') )
sequence.append( lp020201.LP_020201_DL_PushToLeadDestination_Validation() )
sequence.append( appsequence.LPSetVersion('2.2.1') )

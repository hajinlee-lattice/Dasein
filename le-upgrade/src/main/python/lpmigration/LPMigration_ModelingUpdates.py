...
class LPMigration_ModelingUpdates(StepBase):
    ...
    def apply( self, appseq ):
        ...
        spec_Lead_InDateRangeForModeling = 'SpecLatticeFunction(LatticeFunctionExpressionTransform(LatticeFunctionExpression(LatticeFunctionOperatorIdentifier("AND"), LatticeFunctionExpression(LatticeFunctionOperatorIdentifier("Greater"), LatticeFunctionExpression(LatticeFunctionOperatorIdentifier("AddDay"), LatticeFunctionIdentifier(ContainerElementName("Alias_ModifiedDate_Lead")), LatticeFunctionIdentifier(ContainerElementName("Const_DaysOfDataForModeling"))), LatticeFunctionExpressionTransform(LatticeFunctionExpressionTransform(LatticeFunctionIdentifier(ContainerElementName("Alias_ModifiedDate_Lead")), LatticeAddressSetIdentifier(ContainerElementName("Alias_AllLeadTable")), FunctionAggregationOperator("Max")), LatticeAddressSetPi(LatticeAddressExpressionAtomic(LatticeAddressAtomicAll)), FunctionAggregationOperator("None"))), LatticeFunctionExpression(LatticeFunctionOperatorIdentifier("Greater"), LatticeFunctionExpression(LatticeFunctionOperatorIdentifier("Minus"), LatticeFunctionExpression(LatticeFunctionOperatorIdentifier("ConvertToInt"), LatticeFunctionExpressionTransform(LatticeFunctionExpressionTransform(LatticeFunctionIdentifier(ContainerElementName("Alias_CreatedDate_Lead")), LatticeAddressSetIdentifier(ContainerElementName("Alias_AllLeadTable")), FunctionAggregationOperator("Max")), LatticeAddressSetPi(LatticeAddressExpressionAtomic(LatticeAddressAtomicAll)), FunctionAggregationOperator("None"))), LatticeFunctionExpression(LatticeFunctionOperatorIdentifier("IsNull"), LatticeFunctionExpression(LatticeFunctionOperatorIdentifier("ConvertToInt"), LatticeFunctionIdentifier(ContainerElementName("Alias_CreatedDate_Lead"))), LatticeFunctionExpressionConstantScalar("0", DataTypeInt))), LatticeFunctionExpression(LatticeFunctionOperatorIdentifier("Multiply"), LatticeFunctionExpressionConstant("86400", DataTypeInt), LatticeFunctionIdentifier(ContainerElementName("Const_DaysFromLeadCreationDate"))))), LatticeAddressSetIdentifier(ContainerElementName("Alias_AllLeadTable")), FunctionAggregationOperator("Max")), DataTypeUnknown, SpecFunctionTypeMetric, SpecFunctionSourceTypeCalculation, SpecDefaultValueNull, SpecDescription(""))'

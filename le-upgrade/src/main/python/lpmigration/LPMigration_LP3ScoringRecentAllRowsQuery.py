...
class LPMigration_LP3ScoringRecentAllRowsQuery(StepBase):
    ...
    def apply( self, appseq ):
        ...
        exp_AppData_Lead_IsConsideredForModeling = conn_mgr.getNamedExpression('AppData_Lead_IsConsideredForModeling')
        defn_AppData_Lead_IsCreatedSinceModeling = exp_AppData_Lead_IsConsideredForModeling.Object().definition()\
                .replace('Lead_InDateRangeForModeling', 'Lead_InDateRangeForLastMonth')
        exp_AppData_Lead_IsCreatedSinceModeling = NamedExpressionVDBImpl(
                'AppData_Lead_IsCreatedSinceModeling',
                ExpressionVDBImplFactory.create(defn_AppData_Lead_IsCreatedSinceModeling),
                exp_AppData_Lead_IsConsideredForModeling.OtherSpecs())

        conn_mgr.setNamedExpression(exp_AppData_Lead_IsCreatedSinceModeling)

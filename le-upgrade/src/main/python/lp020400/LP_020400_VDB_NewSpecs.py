...
class LP_020400_VDB_NewSpecs( StepBase ):
  ...
  def __init__( self, forceApply = False ):
    super( LP_020400_VDB_NewSpecs, self ).__init__( forceApply )
  ...
  def apply( self, appseq ):
    ...
    newSpecsFileName = 'LP_' + template_type + '_NewSpecs_2.4.0_from_2.3.0.maude'

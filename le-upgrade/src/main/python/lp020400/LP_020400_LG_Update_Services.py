...
#Create Load Group 'Download_ExtendedDataset'
    ...
    if type == 'MKTO':
      ...
      lgm.setLoadGroup(lme_xml)
       ...
       lme_moe_xml = ''
       lme_noe_xml = ''
       lgm.createLoadGroup('LoadMAPData_ModLeads_Extend', 'OperationalProcess\Standard',  'LoadMAPData_ModLeads_Extend', True, False)
       lme_moe_xml = '''<group name="LoadMAPData_ModLeads_Extend" alias="LoadMAPData_ModLeads_Extend" w="Workspace" type="1" scheduleType="0" allowUserChangeScheduleType="False" visibleForEndUser="True" threshold="10000" launchExpiredDays="7" createdBy="YTian@Lattice-Engines.com" path="OperationalProcess\Standard" autoGenerated="False" validationValidMinutes="120" autoClearOnFailure="False" mergeRulesSaved="True" ng="False">
      <schemas/>
      <visiDBConfigurationWithMacros/>
      <targetQueries/>
      <targetQuerySequences/>
      <gvqs/>
      <rdss>
        <rds n="ELQ_Contact" w="Workspace" sn="ELQ_Contact" cn="Eloqua_DataProvider" u="False" ss="" tn="Contact" nmo="1" f="@RecordCOUNT(#MaxNumberOfModifiedLeadsToDownload)&#13;&#10;AND&#13;&#10;ContactID &lt;= #Max_ELQ_Contact_ContactID&#13;&#10;AND&#13;&#10;@datediff(#ExtendedDataset_UpperLimitTime, month(6))&#13;&#10;AND&#13;&#10;(&#13;&#10;      C_DateModified &gt; #LowerLimit_DateModified&#13;&#10;  AND C_DateModified &lt; #UpperLimit_DateModified&#13;&#10;  AND ContactID      &gt; #ContinueFromContactID&#13;&#10;)" ad="True" em="False" td="False" ic="" dd="" l="1000" tw="False" sr="50000" htw="24" mtw="60" emt="False" acd="True" mgf="True" eo="2" emd="True" eo_sftp="1">
          <ts>
            <t n="MaxNumberOfModifiedLeadsToDownload" t="1" qn="Q_Get_ThrottlingParameters" cn="MaxNumberOfModifiedLeadsToDownload" m="0">
              <schemas/>
              <specs/>
            </t>
            <t n="Max_ELQ_Contact_ContactID" t="1" qn="Q_Get_ThrottlingParameters" cn="Max_ELQ_Contact_ContactID" m="0">
              <schemas/>
              <specs/>
            </t>
            <t n="ContinueFromContactID" t="1" qn="Q_Get_ThrottlingParameters" cn="ContinueFromContactID" m="0">
              <schemas/>
              <specs/>
            </t>
            <t n="UpperLimit_DateModified" t="1" qn="Q_Get_ThrottlingParameters" cn="UpperLimit_DateModified" m="0">
              <schemas/>
              <specs/>
            </t>
            <t n="LowerLimit_DateModified" t="1" qn="Q_Get_ThrottlingParameters" cn="LowerLimit_DateModified" m="0">
              <schemas/>
              <specs/>
            </t>
            <t n="ExtendedDataset_UpperLimitTime" t="1" qn="Q_Services_ExtractLeadsRange" cn="ExtendedDataset_UpperLimitTime" m="0">
      ...
      <ces/>
      <extractQueries>
        <extractQuery qw="Workspace" queryName="Q_Get_ThrottlingParameters" queryAlias="Q_Get_ThrottlingParameters" sw="Workspace" schemaName="Summary_ThrottlingParameters" at="False" ucm="True">
          <schemas/>
          <specs/>
          <cms>
            <cm qcn="ID" itcn="ID"/>
            <cm qcn="Time_OfCompletion_DownloadedLeads" itcn="Time_OfCompletion_DownloadedLeads"/>
            <cm qcn="MaxNumberOfModifiedLeadsToDownload" itcn="MaxNumberOfModifiedLeadsToDownload"/>
            <cm qcn="Max_ELQ_Contact_DateCreated" itcn="Max_ELQ_Contact_DateCreated"/>
            <cm qcn="ContinueFromContactID" itcn="ContinueFromContactID"/>
            <cm qcn="UpperLimit_DateModified" itcn="UpperLimit_DateModified"/>
            <cm qcn="LowerLimit_DateModified" itcn="LowerLimit_DateModified"/>
            <cm qcn="Max_ELQ_Contact_ContactID" itcn="Max_ELQ_Contact_ContactID"/>
          </cms>
        </extractQuery>
      ...
      <gCs/>
       ...
       lgm.setLoadGroup(lme_moe_xml)

       lgm.createLoadGroup('LoadMAPData_NewLeads_Extend', 'OperationalProcess\Standard',  'LoadMAPData_NewLeads_Extend', True, False)
       lme_noe_xml = '''<group name="LoadMAPData_NewLeads_Extend" alias="LoadMAPData_NewLeads_Extend" w="Workspace" type="1" scheduleType="0" allowUserChangeScheduleType="False" visibleForEndUser="True" threshold="10000" launchExpiredDays="7" createdBy="YTian@Lattice-Engines.com" path="OperationalProcess\Standard" autoGenerated="False" validationValidMinutes="120" autoClearOnFailure="False" mergeRulesSaved="True" ng="False">
      <schemas/>
      <visiDBConfigurationWithMacros/>
      <targetQueries/>
      <targetQuerySequences/>
      <gvqs/>
      <rdss>
        <rds n="ELQ_Contact" w="Workspace" sn="ELQ_Contact" cn="Eloqua_DataProvider" u="False" ss="" tn="Contact" nmo="1" f="ContactID  &gt; #Max_ELQ_Contact_ContactID AND @datediff(#ExtendedDataset_UpperLimitTime, month(6))" ad="True" em="False" td="False" ic="" dd="" l="1000" tw="False" sr="50000" htw="24" mtw="60" emt="False" acd="True" mgf="True" eo="2" emd="True" eo_sftp="1">
          <ts>
            <t n="Max_ELQ_Contact_ContactID" t="1" qn="Q_Get_MaxContactID" cn="Max_ELQ_Contact_ContactID" m="0">
              <schemas/>
              <specs/>
            </t>
            <t n="ExtendedDataset_UpperLimitTime" t="1" qn="Q_Services_ExtractLeadsRange" cn="ExtendedDataset_UpperLimitTime" m="0">
      ...
      <extractQueries>
        ...
        <extractQuery qw="Workspace" queryName="Q_Get_MaxContactID" queryAlias="Q_Get_MaxContactID" sw="Workspace" schemaName="Summary_MaxContactID" at="False" ucm="True">
          <schemas/>
          <specs/>
          <cms>
            <cm qcn="ID" itcn="ID"/>
      ...
      <gCs/>
       ...
       lgm.setLoadGroup(lme_noe_xml)

       lgm.createLoadGroup('LoadMAPData_Extended', 'BulkScoring\Standard',  'LoadMAPData_Extended', True, True)
       lme_xml = '''<group name="LoadMAPData_Extended" alias="LoadMAPData_Extended" type="1" scheduleType="0" allowUserChangeScheduleType="False" visibleForEndUser="True" threshold="10000" launchExpiredDays="7" createdBy="YTian@Lattice-Engines.com" path="BulkScoring\Standard" autoGenerated="False" validationValidMinutes="120" autoClearOnFailure="False" mergeRulesSaved="False" ng="True">
      <schemas/>
      <ngs>
        <ng n="LoadMAPData_NewLeads_Extend"/>
        <ng n="LoadMAPData_ModLeads_Extend"/>
      </ngs>
      <visiDBConfigurationWithMacros/>
      <targetQueries/>
      <targetQuerySequences/>

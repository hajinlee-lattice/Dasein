...
class LP_020403_Adhoc_LeadRescore_InDateRange(StepBase):
  ...
  def apply(self, appseq):
    ...
    ptsd_lss_xml = lgm.getLoadGroupFunctionality('PushToScoringDB_Step1','lssbardins')

...
sequence = []
sequence.append( appsequence.LPCheckVersion('2.4.1', True) )
sequence.append( lp020402.LP_020402_PLS_ToBeScored_Incr() )
#sequence.append( appsequence.LPSetVersion('2.4.2') )

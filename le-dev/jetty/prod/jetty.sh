...
#
HADOOP_HOME=/var/lib/hadoop-2.2.0.2.0.6.0-102
SQOOP_HOME=/var/lib/sqoop-1.4.4.2.0.6.1-102.bin__hadoop-2.2.0.2.0.6.0-102
JAVA_HOME=/usr/java/default

JETTY_HOME=/opt/jetty
#JETTY_USER=lattice\\s-analytics
JETTY_USER=yarn
JETTY_HOST=0.0.0.0
JETTY_LOGS=logs
JETTY_ARGS=jetty.host=0.0.0.0
JAVA_OPTIONS=(-XX:MaxPermSize=256m -Dsqoop.throwOnError=true -Djetty.class.path=$JAVA_HOME/lib/tools.jar:$HADOOP_HOME/share/hadoop/common/hadoop-common-2.2.0.2.0.6.0-102.jar:/etc/hadoop/conf.empty -DAPI_PROPDIR=/etc/ledp -DDATAPLATFORM_PROPDIR=/etc/ledp)
...
RUN_ARGS=(${JAVA_OPTIONS[@]} -jar "$JETTY_START" $HADOOP_CONF ${JETTY_ARGS[*]})

...
export CATALINA_OPTS="${CATALINA_OPTS:-} -server -Xmx4g -XX:ReservedCodeCacheSize=512m"
...
export CATALINA_CLASSPATH="${CLASSPATH:+$CLASSPATH:}${TEZ_CONF_DIR:+$TEZ_CONF_DIR:}${HADOOP_HOME:+$HADOOP_HOME/etc/hadoop:$HADOOP_HOME/share/hadoop/common}"

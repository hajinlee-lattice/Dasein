...
VALUES
  ...
  ('PetitFour', 'MatchPlanner,EntitySystemIdBased,FuzzyMatch,EntityDunsBased,EntityDomainCountryBased,EntityNameCountryBased,EntityIdAssociate,EntityIdResolve', '0', '0:1,2,3,4,5,6,7', 'Default for Account entity', 'FuzzyMatch:IceCreamSandwich', 'Account', 3),
  ('Cupcake', 'MatchPlanner,EntitySystemIdBased,AccountMatch,EntityEmailBased,EntityNameCountryBased,EntityIdAssociate,EntityIdResolve', '0', '0:1,2,3,4,5,6', 'Default for Contact entity', 'AccountMatch:PetitFour', 'Contact', NULL);

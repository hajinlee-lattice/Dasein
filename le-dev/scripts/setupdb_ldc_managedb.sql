...
VALUES
  ...
  ('PetitFour', 'MatchPlanner,EntitySystemIdBased,FuzzyMatch,EntityDunsBased,EntityDomainBased,EntityNameBased,EntityIdAssociate,EntityIdResolve', '0', '0:1,2,3,4,5,6,7', 'Default for Account entity', 'FuzzyMatch:IceCreamSandwich'),
  ('Cupcake', 'MatchPlanner,EntitySystemIdBased,AccountMatch,EntityEmailBased,EntityNameBased,EntityIdAssociate,EntityIdResolve', '0', '0:1,2,3,4,5,6', 'Default for Contact entity', 'AccountMatch:PetitFour');;

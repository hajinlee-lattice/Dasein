...
public abstract class BaseWorkflowStep<T extends BaseStepConfiguration> extends AbstractStep<T> {
    ...
    protected static final String PERIOD_STORE_SIGNATURE_TABLE_NAME = "PERIOD_STORE_SIGNATURE_TABLE_NAME";
    protected static final String PERIOD_STORE_CTXKEY_TABLE_NAME = "PERIOD_STORE_CTXKEY_TABLE_NAME";
